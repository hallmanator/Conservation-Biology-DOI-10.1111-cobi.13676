...
occurrence.file <- "spto_Chapter4.csv"
...
observations.covariates.file = "spto_Chapter4.csv" 

TruncationD = 150 # This would be the truncation distance decided upon if there is one.
...
###### Run the gbm ######
lr = 0.005 # This is what I'm going to have to optimize as I go. Will take a couple tries.
...
covs <- observation.covariates.data[,c("Julian_Dat", "Year", "Observer", "Minutes_si", "urban_highmed_utm10_165", # First add detection covariates
                                       ...
                                       "devli_utm10_165", "devli_utm10_315", "devli_utm10_615", "devli_utm10_1215", 
                                       "ctf_utm10_165", "ctf_utm10_315", "ctf_utm10_615", "ctf_utm10_1215", 
...
dist.models$observer_date_timeXriparian165 <- update(dist.models$observer_date_time, ~. ~riparian2531_utm10_165, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXriparian165)

dist.models$observer_date_timeXriparian315 <- update(dist.models$observer_date_time, ~. ~riparian2531_utm10_315, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXriparian315)

dist.models$observer_date_timeXriparian615 <- update(dist.models$observer_date_time, ~. ~riparian2531_utm10_615, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXriparian615)

dist.models$observer_date_timeXriparian1215 <- update(dist.models$observer_date_time, ~. ~riparian2531_utm10_1215, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXriparian1215)


## Now going to try npow
dist.models$observer_date_timeXnpow165 <- update(dist.models$observer_date_time, ~. ~npow16_utm10_165, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXnpow165)

dist.models$observer_date_timeXnpow315 <- update(dist.models$observer_date_time, ~. ~npow16_utm10_315, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXnpow315)

dist.models$observer_date_timeXnpow615 <- update(dist.models$observer_date_time, ~. ~npow16_utm10_615, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXnpow615)

dist.models$observer_date_timeXnpow1215 <- update(dist.models$observer_date_time, ~. ~npow16_utm10_1215, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXnpow1215)


## Now going to try wvups
dist.models$observer_date_timeXwvups165 <- update(dist.models$observer_date_time, ~. ~wvups22_utm10_165, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwvups165)

dist.models$observer_date_timeXwvups315 <- update(dist.models$observer_date_time, ~. ~wvups22_utm10_315, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwvups315)

dist.models$observer_date_timeXwvups615 <- update(dist.models$observer_date_time, ~. ~wvups22_utm10_615, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwvups615)

dist.models$observer_date_timeXwvups1215 <- update(dist.models$observer_date_time, ~. ~wvups22_utm10_1215, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwvups1215)


## Now going to try any cover with developed open spaces
dist.models$observer_date_timeXdevos165 <- update(dist.models$observer_date_time, ~. ~devos_utm10_165, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos165)

dist.models$observer_date_timeXdevos315 <- update(dist.models$observer_date_time, ~. ~devos_utm10_315, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos315)

dist.models$observer_date_timeXdevos615 <- update(dist.models$observer_date_time, ~. ~devos_utm10_615, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos615)

dist.models$observer_date_timeXdevos1215 <- update(dist.models$observer_date_time, ~. ~devos_utm10_1215, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos1215)


## Now going to try any cover with lightly developed
dist.models$observer_date_timeXdevli165 <- update(dist.models$observer_date_time, ~. ~devli_utm10_165, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevli165)

dist.models$observer_date_timeXdevli315 <- update(dist.models$observer_date_time, ~. ~devli_utm10_315, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevli315)

dist.models$observer_date_timeXdevli615 <- update(dist.models$observer_date_time, ~. ~devli_utm10_615, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevli615)

dist.models$observer_date_timeXdevli1215 <- update(dist.models$observer_date_time, ~. ~devli_utm10_1215, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevli1215)


## Now going to try any cover with warm temperate forest
dist.models$observer_date_timeXwtf165 <- update(dist.models$observer_date_time, ~. ~wtf_utm10_165, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwtf165)

dist.models$observer_date_timeXwtf315 <- update(dist.models$observer_date_time, ~. ~wtf_utm10_315, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwtf315)

dist.models$observer_date_timeXwtf615 <- update(dist.models$observer_date_time, ~. ~wtf_utm10_615, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwtf615)

dist.models$observer_date_timeXwtf1215 <- update(dist.models$observer_date_time, ~. ~wtf_utm10_1215, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwtf1215)


## Now going to try any cover with cool temperate forest
dist.models$observer_date_timeXctf165 <- update(dist.models$observer_date_time, ~. ~ctf_utm10_165, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXctf165)

dist.models$observer_date_timeXctf315 <- update(dist.models$observer_date_time, ~. ~ctf_utm10_315, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXctf315)

dist.models$observer_date_timeXctf615 <- update(dist.models$observer_date_time, ~. ~ctf_utm10_615, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXctf615)

dist.models$observer_date_timeXctf1215 <- update(dist.models$observer_date_time, ~. ~ctf_utm10_1215, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXctf1215)
...
dist.models$observer_date_timeXpred.occur <- update(dist.models$observer_date_time, ~. ~Pred.Occur, starts = c(-0.536452, -0.000839, -2.1626, 5.9518, 6.1877, 5.9445, 0.0548, -0.0894)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXpred.occur)

dist.models$observer_date_timeXpred.occur2 <- update(dist.models$observer_date_time, ~. ~Pred.Occur + I(Pred.Occur^2), starts = c(-2.94, 0.0, 0.0, -2.0243, 5.8828, 6.0379, 5.8381, 0.0473, -0.0866)) # Update the best detection model with density covariates
...
dist.models$nullXpred.occur <- update(dist.models$null, ~. ~Pred.Occur) # Update the best detection model with density covariates
summary(dist.models$nullXpred.occur)

dist.models$observerXpred.occur <- update(dist.models$observer, ~. ~Pred.Occur ) # Update the best detection model with density covariates
summary(dist.models$observerXpred.occur)

dist.models$dateXpred.occur <- update(dist.models$date, ~. ~Pred.Occur ) # Update the best detection model with density covariates
summary(dist.models$dateXpred.occur)

dist.models$timeXpred.occur <- update(dist.models$time, ~. ~Pred.Occur ) # Update the best detection model with density covariates
summary(dist.models$timeXpred.occur)

dist.models$observer_dateXpred.occur <- update(dist.models$observer_date, ~. ~Pred.Occur) # Update the best detection model with density covariates
summary(dist.models$observer_dateXpred.occur) # Repeated but helps to remember to keep them all

dist.models$observer_timeXpred.occur <- update(dist.models$observer_time, ~. ~Pred.Occur) # Update the best detection model with density covariates
summary(dist.models$observer_timeXpred.occur)

dist.models$date_timeXpred.occur <- update(dist.models$date_time, ~. ~Pred.Occur) # Update the best detection model with density covariates
summary(dist.models$date_timeXpred.occur)

dist.models$observer_date_timeXpred.occur <- update(dist.models$observer_date_time, ~. ~Pred.Occur) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXpred.occur)
...
density.pred.pred.occur2 <- predict(dist.models$observer_date_timeXpred.occur, type = "state", newdata = newdat, appendData=TRUE); density.pred.pred.occur2


jpeg(file.path(output.directory, paste( model.name, '_distsamp_predoccur.jpg', sep="")))

plot(Pred.Occur.seq, density.pred.pred.occur2[, "Predicted"], xlab="Predicted Occurrence (SDM)", ylab="Predicted density", type='l', 
...
# Goodness of fit
pb.dist <- parboot(dist.models$observer_date_timeXpred.occur, fitstats, nsim=100, report=5); pb.dist
...
capture.output(summary(dist.models$observer_date_timeXpred.occur), file = file.path(output.directory,filename))

# Detection probability for all bins within the 300m radius
p.bins <- getP(dist.models$observer_date_timeXpred.occur)
...
p.distsamp <- mean(rowSums(getP(dist.models$observer_date_timeXpred.occur))); p.distsamp

test <- predict(dist.models$observer_date_timeXpred.occur, type = "det", newdata = umf.dist, appendData=FALSE)
...
#gdist.models$observer <- gdistsamp(~1, ~1, ~Observer, data=umf.gdist, keyfun="halfnorm", output="density", mixture="NB", K=10, starts = c(-0.599, -1.14, 4.91, 5.19, 4.93,  8.4))
#summary(gdist.models$observer)

gdist.models$date <- gdistsamp(~1, ~1, ~JulDat, data=umf.gdist, keyfun="halfnorm", output="density", mixture="NB", K=10)
...
## For spto I'm starting with Riparian
gdist.models$date_timeXriparian165 <- update(gdist.models$date_time, ~riparian2531_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXriparian165)

gdist.models$date_timeXriparian315 <- update(gdist.models$date_time, ~riparian2531_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXriparian315)

gdist.models$date_timeXriparian615 <- update(gdist.models$date_time, ~riparian2531_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXriparian615)

gdist.models$date_timeXriparian1215 <- update(gdist.models$date_time, ~riparian2531_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXriparian1215)


## Now going to try npow
gdist.models$date_timeXnpow165 <- update(gdist.models$date_time, ~npow16_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXnpow165)

gdist.models$date_timeXnpow315 <- update(gdist.models$date_time, ~npow16_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXnpow315)

gdist.models$date_timeXnpow615 <- update(gdist.models$date_time, ~npow16_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXnpow615)

gdist.models$date_timeXnpow1215 <- update(gdist.models$date_time, ~npow16_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXnpow1215)


## Now going to try wvups
gdist.models$date_timeXwvups165 <- update(gdist.models$date_time, ~wvups22_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXwvups165)

gdist.models$date_timeXwvups315 <- update(gdist.models$date_time, ~wvups22_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXwvups315)

gdist.models$date_timeXwvups615 <- update(gdist.models$date_time, ~wvups22_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXwvups615)

gdist.models$date_timeXwvups1215 <- update(gdist.models$date_time, ~wvups22_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXwvups1215)


## Now going to try devos
gdist.models$date_timeXdevos165 <- update(gdist.models$date_time, ~devos_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXdevos165)

gdist.models$date_timeXdevos315 <- update(gdist.models$date_time, ~devos_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXdevos315)

gdist.models$date_timeXdevos615 <- update(gdist.models$date_time, ~devos_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXdevos615)

gdist.models$date_timeXdevos1215 <- update(gdist.models$date_time, ~devos_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXdevos1215)


## Now going to try devli
gdist.models$date_timeXdevli165 <- update(gdist.models$date_time, ~devli_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXdevli165)

gdist.models$date_timeXdevli315 <- update(gdist.models$date_time, ~devli_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXdevli315)

gdist.models$date_timeXdevli615 <- update(gdist.models$date_time, ~devli_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXdevli615)

gdist.models$date_timeXdevli1215 <- update(gdist.models$date_time, ~devli_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXdevli1215)


## Now going to try wtf
gdist.models$date_timeXwtf165 <- update(gdist.models$date_time, ~wtf_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXwtf165)

gdist.models$date_timeXwtf315 <- update(gdist.models$date_time, ~wtf_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXwtf315)

gdist.models$date_timeXwtf615 <- update(gdist.models$date_time, ~wtf_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXwtf615)

gdist.models$date_timeXwtf1215 <- update(gdist.models$date_time, ~wtf_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXwtf1215)


## Now going to try ctf
gdist.models$date_timeXctf165 <- update(gdist.models$date_time, ~ctf_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXctf165)

gdist.models$date_timeXctf315 <- update(gdist.models$date_time, ~ctf_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXctf315)

gdist.models$date_timeXctf615 <- update(gdist.models$date_time, ~ctf_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXctf615)

gdist.models$date_timeXctf1215 <- update(gdist.models$date_time, ~ctf_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$date_timeXctf1215)
...
## Now try with the predicted habitat suitability
gdist.models$date_timeXpred.occur <- update(gdist.models$date_time, ~Pred.Occur, ~., ~., starts = c(-0.571, 0.0, 3.9139, 0.0622, -0.1065, 8.29)) # Update the best detection model with density covariates
summary(gdist.models$date_timeXpred.occur)

gdist.models$date_timeXpred.occur2 <- update(gdist.models$date_time, ~Pred.Occur + I(Pred.Occur^2), ~., ~.) # Update the best detection model with density covariates
...
gdist.models$dateXpred.occur2 <- update(gdist.models$date, ~Pred.Occur + I(Pred.Occur^2), ~., ~.) 
summary(gdist.models$dateXpred.occur2)

gdist.models$timeXpred.occur2 <- update(gdist.models$time, ~Pred.Occur + I(Pred.Occur^2), ~., ~.) 
...
## Now predict with top model
newdat <- data.frame(Pred.Occur = Pred.Occur.seq)
density.pred.pred.occur2.gdist <- predict(gdist.models$date_timeXpred.occur2, type = "lambda", newdata = newdat, appendData=TRUE); density.pred.pred.occur2.gdist
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.gdist <- parboot(gdist.models$date_timeXpred.occur2, fitstats, nsim=100, report=5); pb.gdist # Can't do this apparently because of the issues in the model
...
capture.output(summary(gdist.models$date_timeXpred.occur2), file = file.path(output.directory,filename))

# Detection probability for all bins within the 300m radius
p.bins <- getP(gdist.models$date_timeXpred.occur2)
head(p.bins) # This shows that the detection probability increases then decreases. This isn't right. I may have to change the bins to fix this. 

p.gdistsamp <- mean(rowSums(getP(gdist.models$date_timeXpred.occur2))); p.gdistsamp

test <- predict(gdist.models$date_timeXpred.occur2, type = "det", newdata = umf.gdist, appendData=FALSE)
head(test) # These are the sigmas that affect the slope of the detection function
...
Rem.models$observer_timeXriparian165 <- multinomPois(~ Observer + Time ~ riparian2531_utm10_165, umf.rem)
summary(Rem.models$observer_timeXriparian165)

Rem.models$observer_timeXriparian315 <- multinomPois(~ Observer + Time ~ riparian2531_utm10_315, umf.rem)
summary(Rem.models$observer_timeXriparian315)

Rem.models$observer_timeXriparian615 <- multinomPois(~ Observer + Time ~ riparian2531_utm10_615, umf.rem)
summary(Rem.models$observer_timeXriparian615)

Rem.models$observer_timeXriparian1215 <- multinomPois(~ Observer + Time  ~ riparian2531_utm10_1215, umf.rem)
summary(Rem.models$observer_timeXriparian1215)
...
# npow
Rem.models$observer_timeXnpow165 <- multinomPois(~ Observer + Time ~ npow16_utm10_165, umf.rem)
summary(Rem.models$observer_timeXnpow165)

Rem.models$observer_timeXnpow315 <- multinomPois(~ Observer + Time ~ npow16_utm10_315, umf.rem)
summary(Rem.models$observer_timeXnpow315)

Rem.models$observer_timeXnpow615 <- multinomPois(~ Observer + Time ~ npow16_utm10_615, umf.rem)
summary(Rem.models$observer_timeXnpow615)

Rem.models$observer_timeXnpow1215 <- multinomPois(~ Observer + Time  ~ npow16_utm10_1215, umf.rem)
summary(Rem.models$observer_timeXnpow1215)


# wvups
Rem.models$observer_timeXwvups165 <- multinomPois(~ Observer + Time ~ wvups22_utm10_165, umf.rem)
summary(Rem.models$observer_timeXwvups165)

Rem.models$observer_timeXwvups315 <- multinomPois(~ Observer + Time ~ wvups22_utm10_315, umf.rem)
summary(Rem.models$observer_timeXwvups315)

Rem.models$observer_timeXwvups615 <- multinomPois(~ Observer + Time ~ wvups22_utm10_615, umf.rem)
summary(Rem.models$observer_timeXwvups615)

Rem.models$observer_timeXwvups1215 <- multinomPois(~ Observer + Time  ~ wvups22_utm10_1215, umf.rem)
summary(Rem.models$observer_timeXwvups1215)


# Now try devos
Rem.models$observer_timeXdevos165 <- multinomPois(~ Observer + Time ~ devos_utm10_165, umf.rem)
summary(Rem.models$observer_timeXdevos165)

Rem.models$observer_timeXdevos315 <- multinomPois(~ Observer + Time ~ devos_utm10_315, umf.rem)
summary(Rem.models$observer_timeXdevos315)

Rem.models$observer_timeXdevos615 <- multinomPois(~ Observer + Time ~ devos_utm10_615, umf.rem)
summary(Rem.models$observer_timeXdevos615)

Rem.models$observer_timeXdevos1215 <- multinomPois(~ Observer + Time  ~ devos_utm10_1215, umf.rem)
summary(Rem.models$observer_timeXdevos1215)


# Now try devli
Rem.models$observer_timeXdevli165 <- multinomPois(~ Observer + Time ~ devli_utm10_165, umf.rem)
summary(Rem.models$observer_timeXdevli165)

Rem.models$observer_timeXdevli315 <- multinomPois(~ Observer + Time ~ devli_utm10_315, umf.rem)
summary(Rem.models$observer_timeXdevli315)

Rem.models$observer_timeXdevli615 <- multinomPois(~ Observer + Time ~ devli_utm10_615, umf.rem)
summary(Rem.models$observer_timeXdevli615)

Rem.models$observer_timeXdevli1215 <- multinomPois(~ Observer + Time  ~ devli_utm10_1215, umf.rem)
summary(Rem.models$observer_timeXdevli1215)


# Now try ctf
Rem.models$observer_timeXctf165 <- multinomPois(~ Observer + Time ~ ctf_utm10_165, umf.rem)
summary(Rem.models$observer_timeXctf165)

Rem.models$observer_timeXctf315 <- multinomPois(~ Observer + Time ~ ctf_utm10_315, umf.rem)
summary(Rem.models$observer_timeXctf315)

Rem.models$observer_timeXctf615 <- multinomPois(~ Observer + Time ~ ctf_utm10_615, umf.rem)
summary(Rem.models$observer_timeXctf615)

Rem.models$observer_timeXctf1215 <- multinomPois(~ Observer + Time  ~ ctf_utm10_1215, umf.rem)
summary(Rem.models$observer_timeXctf1215)


# Now try wtf
Rem.models$observer_timeXwtf165 <- multinomPois(~ Observer + Time ~ wtf_utm10_165, umf.rem)
summary(Rem.models$observer_timeXwtf165)

Rem.models$observer_timeXwtf315 <- multinomPois(~ Observer + Time ~ wtf_utm10_315, umf.rem)
summary(Rem.models$observer_timeXwtf315)

Rem.models$observer_timeXwtf615 <- multinomPois(~ Observer + Time ~ wtf_utm10_615, umf.rem)
summary(Rem.models$observer_timeXwtf615)

Rem.models$observer_timeXwtf1215 <- multinomPois(~ Observer + Time  ~ wtf_utm10_1215, umf.rem)
summary(Rem.models$observer_timeXwtf1215)
...
Rem.models$observer_timeXpred.occur <- multinomPois(~ Observer + Time ~ Pred.Occur, umf.rem)
summary(Rem.models$observer_timeXpred.occur)
...
Rem.models$nullXpred.occur <- multinomPois(~ 1 ~ Pred.Occur , umf.rem)
summary(Rem.models$nullXpred.occur)

Rem.models$observerXpred.occur <- multinomPois(~ Observer ~ Pred.Occur , umf.rem)
summary(Rem.models$observerXpred.occur)

Rem.models$dateXpred.occur <- multinomPois(~ JulDat ~ Pred.Occur , umf.rem)
summary(Rem.models$dateXpred.occur)

Rem.models$timeXpred.occur <- multinomPois(~ Time ~ Pred.Occur , umf.rem)
summary(Rem.models$timeXpred.occur)
...
Rem.models$observer_date_timeXpred.occur <- multinomPois(~ Observer + JulDat + Time ~ Pred.Occur , umf.rem)
summary(Rem.models$observer_date_timeXpred.occur)
...
abundance.pred.pred.occur2.rem <- predict(Rem.models$observer_timeXpred.occur, type = "state", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.rem

## Make a figure
jpeg(file.path(output.directory, paste( model.name, '_rem_predoccur.jpg', sep="")))

plot(Pred.Occur.seq, abundance.pred.pred.occur2.rem[, "Predicted"], xlab="Predicted Occurrence (SDM)", ylab="Predicted abundance (300m radius)", type='l', 
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.rem <- parboot(Rem.models$observer_timeXpred.occur, fitstats, nsim=100, report=5); pb.rem # Can't do this apparently because of the issues in the model
...
capture.output(summary(Rem.models$observer_timeXpred.occur), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.rem <- mean(rowSums(getP(Rem.models$observer_timeXpred.occur))); p.rem
...
gRem.models$observer <- gmultmix(~ 1, ~ 1, ~ Observer, umf.grem, mixture="NB", K=10, starts = c(-0.0935, -9.85, 9.82, 9.82, 9.94, 5))
...
gRem.models$observer_time <- gmultmix(~ 1, ~ 1, ~ Observer + Time, umf.grem, mixture="NB", K=10, starts = c(-0.0935, -9.85, 9.82, 9.82, 9.94, 0, 5))
...
gRem.models$observer_date_time <- gmultmix(~ 1, ~ 1, ~ Observer + JulDat + Time, umf.grem, mixture="NB", K=10, starts = c(-0.0039, -12.08649, 12.05591, 12.15797, 12.05250, 0.00506, 0.0, 4.3))
...
gRem.models$observer_timeXriparian165 <- gmultmix(~ riparian2531_utm10_165, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXriparian165)

gRem.models$observer_timeXriparian315 <- gmultmix(~ riparian2531_utm10_315, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXriparian315)

gRem.models$observer_timeXriparian615 <- gmultmix(~ riparian2531_utm10_615, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXriparian615)

gRem.models$observer_timeXriparian1215 <- gmultmix(~ riparian2531_utm10_1215, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXriparian1215)
...
## NPOW
gRem.models$observer_timeXnpow165 <- gmultmix(~ npow16_utm10_165, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXnpow165)

gRem.models$observer_timeXnpow315 <- gmultmix(~ npow16_utm10_315, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXnpow315)

gRem.models$observer_timeXnpow615 <- gmultmix(~ npow16_utm10_615, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXnpow615)

gRem.models$observer_timeXnpow1215 <- gmultmix(~ npow16_utm10_1215, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXnpow1215)


## WVUPS
gRem.models$observer_timeXwvups165 <- gmultmix(~ wvups22_utm10_165, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXwvups165)

gRem.models$observer_timeXwvups315 <- gmultmix(~ wvups22_utm10_315, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXwvups315)

gRem.models$observer_timeXwvups615 <- gmultmix(~ wvups22_utm10_615, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXwvups615)

#gRem.models$observer_timeXwvups1215 <- gmultmix(~ wvups22_utm10_1215, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
#summary(gRem.models$observer_timeXwvups1215)


## devos
gRem.models$observer_timeXdevos165 <- gmultmix(~ devos_utm10_165, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXdevos165)

gRem.models$observer_timeXdevos315 <- gmultmix(~ devos_utm10_315, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXdevos315)

gRem.models$observer_timeXdevos615 <- gmultmix(~ devos_utm10_615, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXdevos615)

gRem.models$observer_timeXdevos1215 <- gmultmix(~ devos_utm10_1215, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXdevos1215)


## devli
gRem.models$observer_timeXdevli165 <- gmultmix(~ devli_utm10_165, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXdevli165)

gRem.models$observer_timeXdevli315 <- gmultmix(~ devli_utm10_315, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXdevli315)

gRem.models$observer_timeXdevli615 <- gmultmix(~ devli_utm10_615, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXdevli615)

gRem.models$observer_timeXdevli1215 <- gmultmix(~ devli_utm10_1215, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXdevli1215)


## ctf
gRem.models$observer_timeXctf165 <- gmultmix(~ ctf_utm10_165, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXctf165)

gRem.models$observer_timeXctf315 <- gmultmix(~ ctf_utm10_315, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXctf315)

gRem.models$observer_timeXctf615 <- gmultmix(~ ctf_utm10_615, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXctf615)

gRem.models$observer_timeXctf1215 <- gmultmix(~ ctf_utm10_1215, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_timeXctf1215)


## wtf
gRem.models$observer_timeXwtf165 <- gmultmix(~ wtf_utm10_165, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXwtf165)

gRem.models$observer_timeXwtf315 <- gmultmix(~ wtf_utm10_315, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXwtf315)

#gRem.models$observer_timeXwtf615 <- gmultmix(~ wtf_utm10_615, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXwtf1215))
#summary(gRem.models$observer_timeXwtf615)

gRem.models$observer_timeXwtf1215 <- gmultmix(~ wtf_utm10_1215, ~ 1, ~ Observer + Time , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observer_timeXriparian165))
summary(gRem.models$observer_timeXwtf1215)
...
## Now try habitat suitability as a predictor of abundance
nullXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ 1, umf.grem, mixture="NB", K=10)
summary(nullXpred.occur)

gRem.models$observer_timeXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ Observer + Time, umf.grem, mixture="NB", K=10, starts = c(-2.22, 3.38, -10.250, 10.542, 10.593, 10.485, -0.177, 7.91))
summary(gRem.models$observer_timeXpred.occur)

gRem.models$observer_timeXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer + Time, umf.grem, mixture="NB", K=10)
...
## riparian
TOD.models$observer_timeXriparian165 <- multinomPois(~ Observer + Time ~ riparian2531_utm10_165, umf.tod)
summary(TOD.models$observer_timeXriparian165)

TOD.models$observer_timeXriparian315 <- multinomPois(~ Observer + Time ~ riparian2531_utm10_315, umf.tod)
summary(TOD.models$observer_timeXriparian315)

TOD.models$observer_timeXriparian615 <- multinomPois(~ Observer + Time ~ riparian2531_utm10_615, umf.tod)
summary(TOD.models$observer_timeXriparian615)

TOD.models$observer_timeXriparian1215 <- multinomPois(~ Observer + Time ~ riparian2531_utm10_1215, umf.tod)
summary(TOD.models$observer_timeXriparian1215)
...
## npow
TOD.models$observer_timeXnpow165 <- multinomPois(~ Observer + Time ~ npow16_utm10_165, umf.tod)
summary(TOD.models$observer_timeXnpow165)

TOD.models$observer_timeXnpow315 <- multinomPois(~ Observer + Time ~ npow16_utm10_315, umf.tod)
summary(TOD.models$observer_timeXnpow315)

TOD.models$observer_timeXnpow615 <- multinomPois(~ Observer + Time ~ npow16_utm10_615, umf.tod)
summary(TOD.models$observer_timeXnpow615)

TOD.models$observer_timeXnpow1215 <- multinomPois(~ Observer + Time ~ npow16_utm10_1215, umf.tod)
summary(TOD.models$observer_timeXnpow1215)
...
## wvups
TOD.models$observer_timeXwvups165 <- multinomPois(~ Observer + Time ~ wvups22_utm10_165, umf.tod)
summary(TOD.models$observer_timeXwvups165)

TOD.models$observer_timeXwvups315 <- multinomPois(~ Observer + Time ~ wvups22_utm10_315, umf.tod)
summary(TOD.models$observer_timeXwvups315)

TOD.models$observer_timeXwvups615 <- multinomPois(~ Observer + Time ~ wvups22_utm10_615, umf.tod)
summary(TOD.models$observer_timeXwvups615)

TOD.models$observer_timeXwvups1215 <- multinomPois(~ Observer + Time ~ wvups22_utm10_1215, umf.tod)
summary(TOD.models$observer_timeXwvups1215)
...
## devos
TOD.models$observer_timeXdevos165 <- multinomPois(~ Observer + Time ~ devos_utm10_165, umf.tod)
summary(TOD.models$observer_timeXdevos165)

TOD.models$observer_timeXdevos315 <- multinomPois(~ Observer + Time ~ devos_utm10_315, umf.tod)
summary(TOD.models$observer_timeXdevos315)

TOD.models$observer_timeXdevos615 <- multinomPois(~ Observer + Time ~ devos_utm10_615, umf.tod)
summary(TOD.models$observer_timeXdevos615)

TOD.models$observer_timeXdevos1215 <- multinomPois(~ Observer + Time ~ devos_utm10_1215, umf.tod)
summary(TOD.models$observer_timeXdevos1215)
...
## devli
TOD.models$observer_timeXdevli165 <- multinomPois(~ Observer + Time ~ devli_utm10_165, umf.tod)
summary(TOD.models$observer_timeXdevli165)

TOD.models$observer_timeXdevli315 <- multinomPois(~ Observer + Time ~ devli_utm10_315, umf.tod)
summary(TOD.models$observer_timeXdevli315)

TOD.models$observer_timeXdevli615 <- multinomPois(~ Observer + Time ~ devli_utm10_615, umf.tod)
summary(TOD.models$observer_timeXdevli615)

TOD.models$observer_timeXdevli1215 <- multinomPois(~ Observer + Time ~ devli_utm10_1215, umf.tod)
summary(TOD.models$observer_timeXdevli1215)
...
## ctf
TOD.models$observer_timeXctf165 <- multinomPois(~ Observer + Time ~ ctf_utm10_165, umf.tod)
summary(TOD.models$observer_timeXctf165)

TOD.models$observer_timeXctf315 <- multinomPois(~ Observer + Time ~ ctf_utm10_315, umf.tod)
summary(TOD.models$observer_timeXctf315)

TOD.models$observer_timeXctf615 <- multinomPois(~ Observer + Time ~ ctf_utm10_615, umf.tod)
summary(TOD.models$observer_timeXctf615)

TOD.models$observer_timeXctf1215 <- multinomPois(~ Observer + Time ~ ctf_utm10_1215, umf.tod)
summary(TOD.models$observer_timeXctf1215)
...
## wtf
TOD.models$observer_timeXwtf165 <- multinomPois(~ Observer + Time ~ wtf_utm10_165, umf.tod)
summary(TOD.models$observer_timeXwtf165)

TOD.models$observer_timeXwtf315 <- multinomPois(~ Observer + Time ~ wtf_utm10_315, umf.tod)
summary(TOD.models$observer_timeXwtf315)

TOD.models$observer_timeXwtf615 <- multinomPois(~ Observer + Time ~ wtf_utm10_615, umf.tod)
summary(TOD.models$observer_timeXwtf615)

TOD.models$observer_timeXwtf1215 <- multinomPois(~ Observer + Time ~ wtf_utm10_1215, umf.tod)
summary(TOD.models$observer_timeXwtf1215)
...
## Now try habitat suitability as a predictor of abundance
TOD.models$observer_timeXpred.occur <- multinomPois(~ Observer + Time ~ Pred.Occur, umf.tod)
summary(TOD.models$observer_timeXpred.occur)
...
## Now check if the other detection structures perform better with this top abundance structure
TOD.models$nullXpred.occur <- multinomPois(~ 1 ~ Pred.Occur, umf.tod)
summary(TOD.models$nullXpred.occur)

TOD.models$observerXpred.occur <- multinomPois(~ Observer ~ Pred.Occur, umf.tod)
summary(TOD.models$observerXpred.occur)

TOD.models$dateXpred.occur <- multinomPois(~ JulDat ~ Pred.Occur, umf.tod)
summary(TOD.models$dateXpred.occur)

TOD.models$timeXpred.occur <- multinomPois(~ Time ~ Pred.Occur, umf.tod)
summary(TOD.models$timeXpred.occur)

TOD.models$observer_dateXpred.occur <- multinomPois(~ Observer + JulDat ~ Pred.Occur, umf.tod)
summary(TOD.models$observer_dateXpred.occur)

TOD.models$observer_timeXpred.occur <- multinomPois(~ Observer + Time ~ Pred.Occur, umf.tod)
summary(TOD.models$observer_timeXpred.occur)

TOD.models$date_timeXpred.occur <- multinomPois(~ JulDat + Time ~ Pred.Occur, umf.tod)
summary(TOD.models$date_timeXpred.occur)

TOD.models$observer_date_timeXpred.occur <- multinomPois(~ Observer + JulDat + Time ~ Pred.Occur, umf.tod)
summary(TOD.models$observer_date_timeXpred.occur)
...
abundance.pred.pred.occur2.tod <- predict(TOD.models$observer_timeXpred.occur, type = "state", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.tod

## Make a figure
jpeg(file.path(output.directory, paste( model.name, '_tod_predoccur.jpg', sep="")))

plot(Pred.Occur.seq, abundance.pred.pred.occur2.tod[, "Predicted"], xlab="Predicted Occurrence (SDM)", ylab="Predicted abundance (300m radius)", type='l', 
     ylim = c(0,3.1), frame=F, lwd=2)
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.tod <- parboot(TOD.models$observer_timeXpred.occur, fitstats, nsim=100, report=5); pb.tod # Can't do this apparently because of the issues in the model
...
capture.output(summary(TOD.models$observer_timeXpred.occur), file = file.path(output.directory,filename))


# Detection probability for a single pass
#backTransform(Rem.models$date_hwy2Xpred.occur2_wvups165, type="det")
head(getP(TOD.models$observer_timeXpred.occur))

# Detection probability after all passes for each site. Could take an average across all sites
p.tod <- mean(rowSums(getP(TOD.models$observer_timeXpred.occur))); p.tod
...
gTOD.models$observer <- gmultmix(~ 1, ~ 1, ~ Observer, umf.gtod, mixture="NB", K=10, starts = c(-0.119, 0.743, 0.0, 0.0, 0.0, 2.19))
...
## riparian
gTOD.models$observer_timeXriparian165 <- gmultmix(~ riparian2531_utm10_165, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXriparian165)

gTOD.models$observer_timeXriparian315 <- gmultmix(~ riparian2531_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXriparian315)

gTOD.models$observer_timeXriparian615 <- gmultmix(~ riparian2531_utm10_615, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXriparian615)

gTOD.models$observer_timeXriparian1215 <- gmultmix(~ riparian2531_utm10_1215, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXriparian1215)


## npow
gTOD.models$observer_timeXnpow165 <- gmultmix(~ npow16_utm10_165, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXnpow165)

gTOD.models$observer_timeXnpow315 <- gmultmix(~ npow16_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.0292, 0.0, -11.611, 12.221, 12.074, 12.865, -0.098, 4.07))
summary(gTOD.models$observer_timeXnpow315)

gTOD.models$observer_timeXnpow615 <- gmultmix(~ npow16_utm10_615, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXnpow615)

gTOD.models$observer_timeXnpow1215 <- gmultmix(~ npow16_utm10_1215, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXnpow1215)


## wvups
gTOD.models$observer_timeXwvups165 <- gmultmix(~ wvups22_utm10_165, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXwvups165)

gTOD.models$observer_timeXwvups315 <- gmultmix(~ wvups22_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXwvups315)

gTOD.models$observer_timeXwvups615 <- gmultmix(~ wvups22_utm10_615, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXwvups615)

gTOD.models$observer_timeXwvups1215 <- gmultmix(~ wvups22_utm10_1215, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXwvups1215)
...
## devos
gTOD.models$observer_timeXdevos165 <- gmultmix(~ devos_utm10_165, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXdevos165)

gTOD.models$observer_timeXdevos315 <- gmultmix(~ devos_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXdevos315)

gTOD.models$observer_timeXdevos615 <- gmultmix(~ devos_utm10_615, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXdevos615)

gTOD.models$observer_timeXdevos1215 <- gmultmix(~ devos_utm10_1215, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXdevos1215)
...
## devli
gTOD.models$observer_timeXdevli165 <- gmultmix(~ devli_utm10_165, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXdevli165)

gTOD.models$observer_timeXdevli315 <- gmultmix(~ devli_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXdevli315)

gTOD.models$observer_timeXdevli615 <- gmultmix(~ devli_utm10_615, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXdevli615)

gTOD.models$observer_timeXdevli1215 <- gmultmix(~ devli_utm10_1215, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXdevli1215)
...
## ctf
gTOD.models$observer_timeXctf165 <- gmultmix(~ ctf_utm10_165, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXctf165)

gTOD.models$observer_timeXctf315 <- gmultmix(~ ctf_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXctf315)

gTOD.models$observer_timeXctf615 <- gmultmix(~ ctf_utm10_615, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXctf615)

gTOD.models$observer_timeXctf1215 <- gmultmix(~ ctf_utm10_1215, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXctf1215)
...
## wtf
gTOD.models$observer_timeXwtf165 <- gmultmix(~ wtf_utm10_165, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXwtf165)

gTOD.models$observer_timeXwtf315 <- gmultmix(~ wtf_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXwtf315)

gTOD.models$observer_timeXwtf615 <- gmultmix(~ wtf_utm10_615, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXwtf615)

gTOD.models$observer_timeXwtf1215 <- gmultmix(~ wtf_utm10_1215, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXwtf1215)
...
## Now try habitat suitability as a predictor of abundance
gTOD.models$observer_timeXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXpred.occur)
...
## Now check if the other detection structures perform better with this top abundance structure
gTOD.models$nullXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ 1, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$nullXpred.occur)

gTOD.models$observerXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ Observer, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observerXpred.occur)

gTOD.models$dateXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ JulDat, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$dateXpred.occur)

gTOD.models$timeXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$timeXpred.occur)
...
gTOD.models$date_timeXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.119, 3, 0.9851, -0.0445, -0.0745, 2.17))
summary(gTOD.models$date_timeXpred.occur)

gTOD.models$observer_date_timeXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXpred.occur)
...
abundance.pred.pred.occur2.gtod <- predict(gTOD.models$observer_date_timeXpred.occur, type = "lambda", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.gtod

## Make a figure
jpeg(file.path(output.directory, paste( model.name, '_gtod_predoccur.jpg', sep="")))

plot(Pred.Occur.seq, abundance.pred.pred.occur2.gtod[, "Predicted"], xlab="Predicted Occurrence (SDM)", ylab="Predicted abundance (300m radius)", type='l', 
     ylim = c(0,3.1), frame=F, lwd=2)
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.gtod <- parboot(gTOD.models$observer_date_timeXpred.occur, fitstats, nsim=100, report=5); pb.gtod # Can't do this apparently because of the issues in the model
...
capture.output(summary(gTOD.models$observer_date_timeXpred.occur), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.gtod <-mean(rowSums(getP(TOD.models$observer_date_timeXpred.occur))); p.gtod
...
current_suitable <- shapefile(file.path(output.directory, "spto_suitable_poly_current_clipped.shp")) # This is the polygon of just suitable areas
...
historic_suitable <- shapefile(file.path(output.directory, "spto_suitable_poly_historic_clipped.shp")) # This is the polygon of just suitable areas
...
#writeRaster(subset(distsamp.density.current,subset=1), file.path(output.directory, "spto_distsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(distsamp.density.current,subset=2), file.path(output.directory, "spto_distsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(distsamp.density.current,subset=3), file.path(output.directory, "spto_distsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(distsamp.density.current,subset=4), file.path(output.directory, "spto_distsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 


#distsamp.density.historic <- predict(dist.models$observerXpred.occur2, type = "state", newdata = historic.stack)

#writeRaster(subset(distsamp.density.historic,subset=1), file.path(output.directory, "spto_distsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(distsamp.density.historic,subset=2), file.path(output.directory, "spto_distsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(distsamp.density.historic,subset=3), file.path(output.directory, "spto_distsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(distsamp.density.historic,subset=4), file.path(output.directory, "spto_distsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE) 


## Density with gdistsamp (negative binomial) top model
gdistsamp.density.current <- predict(gdist.models$date_timeXpred.occur2, type = "lambda", newdata = current.stack) 

writeRaster(subset(gdistsamp.density.current,subset=1), file.path(output.directory, "spto_gdistsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(gdistsamp.density.current,subset=2), file.path(output.directory, "spto_gdistsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(gdistsamp.density.current,subset=3), file.path(output.directory, "spto_gdistsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(gdistsamp.density.current,subset=4), file.path(output.directory, "spto_gdistsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 

gdistsamp.density.historic <- predict(gdist.models$date_timeXpred.occur2, type = "lambda", newdata = historic.stack) 

writeRaster(subset(gdistsamp.density.historic,subset=1), file.path(output.directory, "spto_gdistsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(gdistsamp.density.historic,subset=2), file.path(output.directory, "spto_gdistsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(gdistsamp.density.historic,subset=3), file.path(output.directory, "spto_gdistsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(gdistsamp.density.historic,subset=4), file.path(output.directory, "spto_gdistsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
rem.abundance.current <- predict(Rem.models$observer_timeXpred.occur, type = "state", newdata = current.stack) 
...
writeRaster(prediction, file.path(output.directory, "spto_rem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "spto_rem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "spto_rem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "spto_rem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

rem.abundance.historic <- predict(Rem.models$observer_timeXpred.occur, type = "state", newdata = historic.stack) 
...
writeRaster(prediction, file.path(output.directory, "spto_rem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "spto_rem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "spto_rem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "spto_rem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "spto_grem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "spto_grem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "spto_grem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "spto_grem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "spto_grem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "spto_grem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "spto_grem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "spto_grem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)


## Density with time of detection top model
tod.density.current <- predict(TOD.models$observer_timeXpred.occur, type = "state", newdata = current.stack) 
...
writeRaster(prediction, file.path(output.directory, "spto_tod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "spto_tod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "spto_tod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "spto_tod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

tod.density.historic <- predict(TOD.models$observer_timeXpred.occur, type = "state", newdata = historic.stack) 
...
writeRaster(prediction, file.path(output.directory, "spto_tod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "spto_tod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "spto_tod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "spto_tod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "spto_gtod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "spto_gtod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "spto_gtod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "spto_gtod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "spto_gtod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "spto_gtod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "spto_gtod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "spto_gtod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
### distsamp
## Current
#current.dens.prediction <- raster(file.path(output.directory, "spto_distsamp_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "spto_distsamp_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "spto_distsamp_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "spto_distsamp_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "spto_distsamp_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "spto_distsamp_historic_density180_upper.tif")) 
...
## gdistsamp
# Current
current.dens.prediction <- raster(file.path(output.directory, "spto_gdistsamp_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "spto_gdistsamp_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "spto_gdistsamp_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "spto_gdistsamp_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "spto_gdistsamp_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "spto_gdistsamp_historic_density180_upper.tif")) 
...
## rem
# Current
current.dens.prediction <- raster(file.path(output.directory, "spto_rem_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "spto_rem_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "spto_rem_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "spto_rem_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "spto_rem_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "spto_rem_historic_density180_upper.tif")) 
...
### grem
## Current
#current.dens.prediction <- raster(file.path(output.directory, "spto_grem_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "spto_grem_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "spto_grem_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "spto_grem_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "spto_grem_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "spto_grem_historic_density180_upper.tif")) 
...
## tod
# Current
current.dens.prediction <- raster(file.path(output.directory, "spto_tod_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "spto_tod_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "spto_tod_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "spto_tod_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "spto_tod_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "spto_tod_historic_density180_upper.tif")) 
...
### gtod
## Current
#current.dens.prediction <- raster(file.path(output.directory, "spto_gtod_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "spto_gtod_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "spto_gtod_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "spto_gtod_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "spto_gtod_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "spto_gtod_historic_density180_upper.tif")) 
