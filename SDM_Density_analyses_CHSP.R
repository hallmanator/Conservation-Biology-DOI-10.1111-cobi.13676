...
occurrence.file <- "chsp_Chapter4.csv"
...
observations.covariates.file = "chsp_Chapter4.csv" 
...
dist.models$observer_time <- distsamp(~Observer + Time ~1, umf.dist, keyfun="halfnorm", output="density", starts = c(-2.94, 0.68401, 3.26561, 3.31770, 3.14396, 0.0))
...
dist.models$observer_date_time <- distsamp(~Observer + JulDat + Time ~1, umf.dist, keyfun="halfnorm", output="density", starts = c(-2.81, -2.5160, 6.3929, 6.4592, 6.2609, 0.0333, 0.0561))
...
## wtf
dist.models$observer_date_timeXwtf165 <- update(dist.models$observer_date_time, ~. ~wtf_utm10_165, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwtf165)

dist.models$observer_date_timeXwtf315 <- update(dist.models$observer_date_time, ~. ~wtf_utm10_315, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwtf315)

dist.models$observer_date_timeXwtf615 <- update(dist.models$observer_date_time, ~. ~wtf_utm10_615, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwtf615)

dist.models$observer_date_timeXwtf1215 <- update(dist.models$observer_date_time, ~. ~wtf_utm10_1215, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwtf1215)


## devos
dist.models$observer_date_timeXdevos165 <- update(dist.models$observer_date_time, ~. ~devos_utm10_165, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos165)

dist.models$observer_date_timeXdevos315 <- update(dist.models$observer_date_time, ~. ~devos_utm10_315, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos315)

dist.models$observer_date_timeXdevos615 <- update(dist.models$observer_date_time, ~. ~devos_utm10_615, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos615)

dist.models$observer_date_timeXdevos1215 <- update(dist.models$observer_date_time, ~. ~devos_utm10_1215, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos1215)


## Now going to try npow
dist.models$observer_date_timeXnpow165 <- update(dist.models$observer_date_time, ~. ~npow16_utm10_165, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXnpow165)

dist.models$observer_date_timeXnpow315 <- update(dist.models$observer_date_time, ~. ~npow16_utm10_315, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXnpow315)

dist.models$observer_date_timeXnpow615 <- update(dist.models$observer_date_time, ~. ~npow16_utm10_615, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXnpow615)

dist.models$observer_date_timeXnpow1215 <- update(dist.models$observer_date_time, ~. ~npow16_utm10_1215, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXnpow1215)


## Now going to try wvups
dist.models$observer_date_timeXwvups165 <- update(dist.models$observer_date_time, ~. ~wvups22_utm10_165, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwvups165)

dist.models$observer_date_timeXwvups315 <- update(dist.models$observer_date_time, ~. ~wvups22_utm10_315, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwvups315)

dist.models$observer_date_timeXwvups615 <- update(dist.models$observer_date_time, ~. ~wvups22_utm10_615, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXwvups615)

dist.models$observer_date_timeXwvups1215 <- update(dist.models$observer_date_time, ~. ~wvups22_utm10_1215, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
...
dist.models$observer_date_timeXpred.occur <- update(dist.models$observer_date_time, ~. ~Pred.Occur, starts = c(-2.1, 0.0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXpred.occur)

dist.models$observer_date_timeXpred.occur2 <- update(dist.models$observer_date_time, ~. ~Pred.Occur + I(Pred.Occur^2), starts = c(-2.1, 0.0, 0, -2.7103, 6.1948, 6.4232, 6.3013, 0.0641, 0.0523)) # Update the best detection model with density covariates
...
dist.models$observer_dateXpred.occur2 <- update(dist.models$observer_date, ~. ~Pred.Occur + I(Pred.Occur^2), starts = c(-2.94, 0.0, 0.0, -0.5626, 4.4124, 4.4698, 4.2805, 0.0591)) # Update the best detection model with density covariates
...
#gdist.models$observer <- gdistsamp(~1, ~1, ~Observer, data=umf.gdist, keyfun="halfnorm", output="density", mixture="NB", K=10, starts = c(-2.22, 3.93, 0, 0, 0, -0.214))
...
## For chsp I'm starting with wtf
gdist.models$dateXwtf165 <- update(gdist.models$date, ~wtf_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXwtf165)

gdist.models$dateXwtf315 <- update(gdist.models$date, ~wtf_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXwtf315)

gdist.models$dateXwtf615 <- update(gdist.models$date, ~wtf_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXwtf615)

gdist.models$dateXwtf1215 <- update(gdist.models$date, ~wtf_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXwtf1215)


## devos
gdist.models$dateXdevos165 <- update(gdist.models$date, ~devos_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXdevos165)

gdist.models$dateXdevos315 <- update(gdist.models$date, ~devos_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXdevos315)

gdist.models$dateXdevos615 <- update(gdist.models$date, ~devos_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXdevos615)

gdist.models$dateXdevos1215 <- update(gdist.models$date, ~devos_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXdevos1215)


## Now going to try npow
gdist.models$dateXnpow165 <- update(gdist.models$date, ~npow16_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXnpow165)

gdist.models$dateXnpow315 <- update(gdist.models$date, ~npow16_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXnpow315)

gdist.models$dateXnpow615 <- update(gdist.models$date, ~npow16_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXnpow615)

gdist.models$dateXnpow1215 <- update(gdist.models$date, ~npow16_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXnpow1215)


## Now going to try wvups
gdist.models$dateXwvups165 <- update(gdist.models$date, ~wvups22_utm10_165, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXwvups165)

gdist.models$dateXwvups315 <- update(gdist.models$date, ~wvups22_utm10_315, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXwvups315)

gdist.models$dateXwvups615 <- update(gdist.models$date, ~wvups22_utm10_615, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXwvups615)

gdist.models$dateXwvups1215 <- update(gdist.models$date, ~wvups22_utm10_1215, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXwvups1215)
...
## Now try with the predicted habitat suitability
gdist.models$dateXpred.occur <- update(gdist.models$date, ~Pred.Occur, ~., ~.) # Update the best detection model with density covariates
summary(gdist.models$dateXpred.occur)

gdist.models$dateXpred.occur2 <- update(gdist.models$date, ~Pred.Occur + I(Pred.Occur^2), ~., ~.) # Update the best detection model with density covariates
...
gdist.models$date_timeXpred.occur2 <- update(gdist.models$date_time, ~Pred.Occur + I(Pred.Occur^2), ~., ~., starts = c(-2.21, 0, 0, 3.6908, 0.0595, 0.0319, -0.22)) # Update the best detection model with density covariates
...
test <- predict(gdist.models$nullXpred.occur2, type = "det", newdata = umf.gdist, appendData=FALSE)
head(test) # These are the sigmas that affect the slope of the detection function
...
# wtf
Rem.models$observerXwtf165 <- multinomPois(~ Observer ~ wtf_utm10_165, umf.rem)
summary(Rem.models$observerXwtf165)

Rem.models$observerXwtf315 <- multinomPois(~ Observer ~ wtf_utm10_315, umf.rem)
summary(Rem.models$observerXwtf315)

Rem.models$observerXwtf615 <- multinomPois(~ Observer ~ wtf_utm10_615, umf.rem)
summary(Rem.models$observerXwtf615)

Rem.models$observerXwtf1215 <- multinomPois(~ Observer  ~ wtf_utm10_1215, umf.rem)
summary(Rem.models$observerXwtf1215)
...
# devos
Rem.models$observerXdevos165 <- multinomPois(~ Observer ~ devos_utm10_165, umf.rem)
summary(Rem.models$observerXdevos165)

Rem.models$observerXdevos315 <- multinomPois(~ Observer ~ devos_utm10_315, umf.rem)
summary(Rem.models$observerXdevos315)

Rem.models$observerXdevos615 <- multinomPois(~ Observer ~ devos_utm10_615, umf.rem)
summary(Rem.models$observerXdevos615)

Rem.models$observerXdevos1215 <- multinomPois(~ Observer  ~ devos_utm10_1215, umf.rem)
summary(Rem.models$observerXdevos1215)
...
# Now try npow
Rem.models$observerXnpow165 <- multinomPois(~ Observer ~ npow16_utm10_165, umf.rem)
summary(Rem.models$observerXnpow165)

Rem.models$observerXnpow315 <- multinomPois(~ Observer ~ npow16_utm10_315, umf.rem)
summary(Rem.models$observerXnpow315)

Rem.models$observerXnpow615 <- multinomPois(~ Observer ~ npow16_utm10_615, umf.rem)
summary(Rem.models$observerXnpow615)

Rem.models$observerXnpow1215 <- multinomPois(~ Observer  ~ npow16_utm10_1215, umf.rem)
summary(Rem.models$observerXnpow1215)


# Now try wvups
Rem.models$observerXwvups165 <- multinomPois(~ Observer ~ wvups22_utm10_165, umf.rem)
summary(Rem.models$observerXwvups165)

Rem.models$observerXwvups315 <- multinomPois(~ Observer ~ wvups22_utm10_315, umf.rem)
summary(Rem.models$observerXwvups315)

Rem.models$observerXwvups615 <- multinomPois(~ Observer ~ wvups22_utm10_615, umf.rem)
summary(Rem.models$observerXwvups615)

Rem.models$observerXwvups1215 <- multinomPois(~ Observer  ~ wvups22_utm10_1215, umf.rem)
summary(Rem.models$observerXwvups1215)
...
abundance.pred.pred.occur2.rem <- predict(Rem.models$observer_dateXpred.occur2, type = "state", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.rem
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.rem <- parboot(Rem.models$observer_dateXpred.occur2, fitstats, nsim=100, report=5); pb.rem # Can't do this apparently because of the issues in the model
...
capture.output(summary(Rem.models$observer_dateXpred.occur2), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.rem <- mean(rowSums(getP(Rem.models$observer_dateXpred.occur2))); p.rem
...
## wtf
gRem.models$observerXwtf165 <- gmultmix(~ wtf_utm10_165, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXwtf165)

gRem.models$observerXwtf315 <- gmultmix(~ wtf_utm10_315, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXwtf315)

gRem.models$observerXwtf615 <- gmultmix(~ wtf_utm10_615, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXwtf615)

gRem.models$dobserverXwtf1215 <- gmultmix(~ wtf_utm10_1215, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$dobserverXwtf1215)
...
## devos
gRem.models$observerXdevos165 <- gmultmix(~ devos_utm10_165, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXdevos165)

gRem.models$observerXdevos315 <- gmultmix(~ devos_utm10_315, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXdevos315)

gRem.models$observerXdevos615 <- gmultmix(~ devos_utm10_615, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXdevos615)

gRem.models$dobserverXdevos1215 <- gmultmix(~ devos_utm10_1215, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$dobserverXdevos1215)


## NPOW
gRem.models$observerXnpow165 <- gmultmix(~ npow16_utm10_165, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXnpow165)

gRem.models$observerXnpow315 <- gmultmix(~ npow16_utm10_315, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10, starts = coef(gRem.models$observerXnpow165))
summary(gRem.models$observerXnpow315)

gRem.models$observerXnpow615 <- gmultmix(~ npow16_utm10_615, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXnpow615)

gRem.models$dobserverXnpow1215 <- gmultmix(~ npow16_utm10_1215, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$dobserverXnpow1215)


## WVUPS
gRem.models$observerXwvups165 <- gmultmix(~ wvups22_utm10_165, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXwvups165)

gRem.models$observerXwvups315 <- gmultmix(~ wvups22_utm10_315, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXwvups315)

gRem.models$observerXwvups615 <- gmultmix(~ wvups22_utm10_615, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXwvups615)

gRem.models$dobserverXwvups1215 <- gmultmix(~ wvups22_utm10_1215, ~ 1, ~ Observer , umf.grem, mixture="NB", K=10)
summary(gRem.models$dobserverXwvups1215)
...
## Now try habitat suitability as a predictor of abundance
gRem.models$observerXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ Observer, umf.grem, mixture="NB", K=10)
summary(gRem.models$observerXpred.occur)

gRem.models$observerXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer, umf.grem, mixture="NB", K=10)
...
abundance.pred.pred.occur2.grem <- predict(gRem.models$observerXpred.occur2, type = "lambda", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.grem
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.grem <- parboot(gRem.models$observerXpred.occur2, fitstats, nsim=10, report=5); pb.grem 
...
capture.output(summary(gRem.models$observerXpred.occur2), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.grem <- mean(rowSums(getP(gRem.models$observerXpred.occur2))); p.grem
...
gTOD.models$observer_timeXnpow315 <- gmultmix(~ npow16_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
...
current_suitable <- shapefile(file.path(output.directory, "chsp_suitable_poly_current_clipped.shp")) # This is the polygon of just suitable areas
...
historic_suitable <- shapefile(file.path(output.directory, "chsp_suitable_poly_historic_clipped.shp")) # This is the polygon of just suitable areas
...
writeRaster(subset(distsamp.density.current,subset=1), file.path(output.directory, "chsp_distsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=2), file.path(output.directory, "chsp_distsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=3), file.path(output.directory, "chsp_distsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=4), file.path(output.directory, "chsp_distsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 


distsamp.density.historic <- predict(dist.models$observer_timeXpred.occur2, type = "state", newdata = historic.stack)

writeRaster(subset(distsamp.density.historic,subset=1), file.path(output.directory, "chsp_distsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=2), file.path(output.directory, "chsp_distsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=3), file.path(output.directory, "chsp_distsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=4), file.path(output.directory, "chsp_distsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE) 
...
#writeRaster(subset(gdistsamp.density.current,subset=1), file.path(output.directory, "chsp_gdistsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=2), file.path(output.directory, "chsp_gdistsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=3), file.path(output.directory, "chsp_gdistsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=4), file.path(output.directory, "chsp_gdistsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 

#gdistsamp.density.historic <- predict(gdist.models$nullXpred.occur2, type = "lambda", newdata = historic.stack) 

#writeRaster(subset(gdistsamp.density.historic,subset=1), file.path(output.directory, "chsp_gdistsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=2), file.path(output.directory, "chsp_gdistsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=3), file.path(output.directory, "chsp_gdistsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=4), file.path(output.directory, "chsp_gdistsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
writeRaster(prediction, file.path(output.directory, "chsp_rem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "chsp_rem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "chsp_rem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "chsp_rem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
writeRaster(prediction, file.path(output.directory, "chsp_rem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "chsp_rem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "chsp_rem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "chsp_rem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "chsp_grem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "chsp_grem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "chsp_grem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "chsp_grem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "chsp_grem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "chsp_grem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "chsp_grem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "chsp_grem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)


## Density with time of detection top model
tod.density.current <- predict(TOD.models$observer_timeXpred.occur2, type = "state", newdata = current.stack) 
...
writeRaster(prediction, file.path(output.directory, "chsp_tod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "chsp_tod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "chsp_tod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "chsp_tod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

tod.density.historic <- predict(TOD.models$observer_timeXpred.occur2, type = "state", newdata = historic.stack) 
...
writeRaster(prediction, file.path(output.directory, "chsp_tod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "chsp_tod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "chsp_tod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "chsp_tod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "chsp_gtod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "chsp_gtod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "chsp_gtod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "chsp_gtod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "chsp_gtod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "chsp_gtod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "chsp_gtod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "chsp_gtod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
## distsamp
# Current
current.dens.prediction <- raster(file.path(output.directory, "chsp_distsamp_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "chsp_distsamp_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "chsp_distsamp_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "chsp_distsamp_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "chsp_distsamp_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "chsp_distsamp_historic_density180_upper.tif")) 
...
### gdistsamp
## Current
#current.dens.prediction <- raster(file.path(output.directory, "chsp_gdistsamp_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "chsp_gdistsamp_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "chsp_gdistsamp_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "chsp_gdistsamp_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "chsp_gdistsamp_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "chsp_gdistsamp_historic_density180_upper.tif")) 
...
## rem
# Current
current.dens.prediction <- raster(file.path(output.directory, "chsp_rem_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "chsp_rem_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "chsp_rem_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "chsp_rem_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "chsp_rem_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "chsp_rem_historic_density180_upper.tif")) 
...
### grem
## Current
#current.dens.prediction <- raster(file.path(output.directory, "chsp_grem_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "chsp_grem_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "chsp_grem_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "chsp_grem_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "chsp_grem_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "chsp_grem_historic_density180_upper.tif")) 
...
## tod
# Current
current.dens.prediction <- raster(file.path(output.directory, "chsp_tod_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "chsp_tod_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "chsp_tod_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "chsp_tod_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "chsp_tod_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "chsp_tod_historic_density180_upper.tif")) 
...
### gtod
## Current
#current.dens.prediction <- raster(file.path(output.directory, "chsp_gtod_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "chsp_gtod_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "chsp_gtod_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "chsp_gtod_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "chsp_gtod_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "chsp_gtod_historic_density180_upper.tif")) 
