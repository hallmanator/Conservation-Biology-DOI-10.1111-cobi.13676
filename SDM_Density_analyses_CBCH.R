...
occurrence.file <- "cbch_Chapter4.csv"
...
observations.covariates.file = "cbch_Chapter4.csv" 

TruncationD = 75 # This would be the truncation distance decided upon if there is one.
...
dist.models$observer_time <- distsamp(~Observer + Time ~1, umf.dist, keyfun="halfnorm", output="density", starts = c(-0.422, -1.82, 22.98, 5.29, 5.25, 0))
...
## conifer
dist.models$observer_date_timeXconifer165 <- update(dist.models$observer_date_time, ~. ~conifer_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXconifer165)

dist.models$observer_date_timeXconifer315 <- update(dist.models$observer_date_time, ~. ~conifer_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXconifer315)

dist.models$observer_date_timeXconifer615 <- update(dist.models$observer_date_time, ~. ~conifer_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXconifer615)

dist.models$observer_date_timeXconifer1215 <- update(dist.models$observer_date_time, ~. ~conifer_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXconifer1215)


## vlmr
dist.models$observer_date_timeXvlmr165 <- update(dist.models$observer_date_time, ~. ~vlmr_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXvlmr165)

dist.models$observer_date_timeXvlmr315 <- update(dist.models$observer_date_time, ~. ~vlmr_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXvlmr315)

dist.models$observer_date_timeXvlmr615 <- update(dist.models$observer_date_time, ~. ~vlmr_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXvlmr615)

dist.models$observer_date_timeXvlmr1215 <- update(dist.models$observer_date_time, ~. ~vlmr_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXvlmr1215)


## ctf
dist.models$observer_date_timeXctf165 <- update(dist.models$observer_date_time, ~. ~ctf_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXctf165)

dist.models$observer_date_timeXctf315 <- update(dist.models$observer_date_time, ~. ~ctf_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXctf315)

dist.models$observer_date_timeXctf615 <- update(dist.models$observer_date_time, ~. ~ctf_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXctf615)

dist.models$observer_date_timeXctf1215 <- update(dist.models$observer_date_time, ~. ~ctf_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXctf1215)


## devli
dist.models$observer_date_timeXdevli165 <- update(dist.models$observer_date_time, ~. ~devli_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevli165)

dist.models$observer_date_timeXdevli315 <- update(dist.models$observer_date_time, ~. ~devli_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevli315)

dist.models$observer_date_timeXdevli615 <- update(dist.models$observer_date_time, ~. ~devli_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevli615)

dist.models$observer_date_timeXdevli1215 <- update(dist.models$observer_date_time, ~. ~devli_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevli1215)


## devos
dist.models$observer_date_timeXdevos165 <- update(dist.models$observer_date_time, ~. ~devos_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos165)

dist.models$observer_date_timeXdevos315 <- update(dist.models$observer_date_time, ~. ~devos_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos315)

dist.models$observer_date_timeXdevos615 <- update(dist.models$observer_date_time, ~. ~devos_utm10_615, starts = coef(dist.models$observer_date_timeXdevos315)) # Update the best detection model with density covariates
summary(dist.models$observer_date_timeXdevos615)

dist.models$observer_date_timeXdevos1215 <- update(dist.models$observer_date_time, ~. ~devos_utm10_1215) # Update the best detection model with density covariates
...
test <- predict(dist.models$observer_timeXpred.occur2, type = "det", newdata = umf.dist, appendData=FALSE)
...
## For cbch I'm starting with Riparian
...
# devli
Rem.models$observer_date_timeXdevli165 <- multinomPois(~ Observer + JulDat + Time ~ devli_utm10_165, umf.rem)
summary(Rem.models$observer_date_timeXdevli165)

Rem.models$observer_date_timeXdevli315 <- multinomPois(~ Observer + JulDat + Time ~ devli_utm10_315, umf.rem)
summary(Rem.models$observer_date_timeXdevli315)

Rem.models$observer_date_timeXdevli615 <- multinomPois(~ Observer + JulDat + Time ~ devli_utm10_615, umf.rem)
summary(Rem.models$observer_date_timeXdevli615)

Rem.models$observer_date_timeXdevli1215 <- multinomPois(~ Observer + JulDat + Time  ~ devli_utm10_1215, umf.rem)
summary(Rem.models$observer_date_timeXdevli1215)
...
abundance.pred.pred.occur2.rem <- predict(Rem.models$observer_timeXpred.occur2, type = "state", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.rem
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.rem <- parboot(Rem.models$observer_timeXpred.occur2, fitstats, nsim=100, report=5); pb.rem # Can't do this apparently because of the issues in the model
...
capture.output(summary(Rem.models$observer_timeXpred.occur2), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.rem <- mean(rowSums(getP(Rem.models$observer_timeXpred.occur2))); p.rem
...
## conifer
TOD.models$observer_date_timeXconifer165 <- multinomPois(~ Observer + JulDat + Time ~ conifer_utm10_165, umf.tod)
summary(TOD.models$observer_date_timeXconifer165)

TOD.models$observer_date_timeXconifer315 <- multinomPois(~ Observer + JulDat + Time ~ conifer_utm10_315, umf.tod)
summary(TOD.models$observer_date_timeXconifer315)

TOD.models$observer_date_timeXconifer615 <- multinomPois(~ Observer + JulDat + Time ~ conifer_utm10_615, umf.tod)
summary(TOD.models$observer_date_timeXconifer615)

TOD.models$observer_date_timeXconifer1215 <- multinomPois(~ Observer + JulDat + Time ~ conifer_utm10_1215, umf.tod)
summary(TOD.models$observer_date_timeXconifer1215)
...
## vlmr
TOD.models$observer_date_timeXvlmr165 <- multinomPois(~ Observer + JulDat + Time ~ vlmr_utm10_165, umf.tod)
summary(TOD.models$observer_date_timeXvlmr165)

TOD.models$observer_date_timeXvlmr315 <- multinomPois(~ Observer + JulDat + Time ~ vlmr_utm10_315, umf.tod)
summary(TOD.models$observer_date_timeXvlmr315)

TOD.models$observer_date_timeXvlmr615 <- multinomPois(~ Observer + JulDat + Time ~ vlmr_utm10_615, umf.tod)
summary(TOD.models$observer_date_timeXvlmr615)

TOD.models$observer_date_timeXvlmr1215 <- multinomPois(~ Observer + JulDat + Time ~ vlmr_utm10_1215, umf.tod)
summary(TOD.models$observer_date_timeXvlmr1215)
...
## ctf
TOD.models$observer_date_timeXctf165 <- multinomPois(~ Observer + JulDat + Time ~ ctf_utm10_165, umf.tod)
summary(TOD.models$observer_date_timeXctf165)

TOD.models$observer_date_timeXctf315 <- multinomPois(~ Observer + JulDat + Time ~ ctf_utm10_315, umf.tod)
summary(TOD.models$observer_date_timeXctf315)

TOD.models$observer_date_timeXctf615 <- multinomPois(~ Observer + JulDat + Time ~ ctf_utm10_615, umf.tod)
summary(TOD.models$observer_date_timeXctf615)

TOD.models$observer_date_timeXctf1215 <- multinomPois(~ Observer + JulDat + Time ~ ctf_utm10_1215, umf.tod)
summary(TOD.models$observer_date_timeXctf1215)
...
## devli
TOD.models$observer_date_timeXdevli165 <- multinomPois(~ Observer + JulDat + Time ~ devli_utm10_165, umf.tod)
summary(TOD.models$observer_date_timeXdevli165)

TOD.models$observer_date_timeXdevli315 <- multinomPois(~ Observer + JulDat + Time ~ devli_utm10_315, umf.tod)
summary(TOD.models$observer_date_timeXdevli315)

TOD.models$observer_date_timeXdevli615 <- multinomPois(~ Observer + JulDat + Time ~ devli_utm10_615, umf.tod)
summary(TOD.models$observer_date_timeXdevli615)

TOD.models$observer_date_timeXdevli1215 <- multinomPois(~ Observer + JulDat + Time ~ devli_utm10_1215, umf.tod)
summary(TOD.models$observer_date_timeXdevli1215)
...
## devos
TOD.models$observer_date_timeXdevos165 <- multinomPois(~ Observer + JulDat + Time ~ devos_utm10_165, umf.tod)
summary(TOD.models$observer_date_timeXdevos165)

TOD.models$observer_date_timeXdevos315 <- multinomPois(~ Observer + JulDat + Time ~ devos_utm10_315, umf.tod)
summary(TOD.models$observer_date_timeXdevos315)

TOD.models$observer_date_timeXdevos615 <- multinomPois(~ Observer + JulDat + Time ~ devos_utm10_615, umf.tod)
summary(TOD.models$observer_date_timeXdevos615)

TOD.models$observer_date_timeXdevos1215 <- multinomPois(~ Observer + JulDat + Time ~ devos_utm10_1215, umf.tod)
summary(TOD.models$observer_date_timeXdevos1215)
...
## conifer
gTOD.models$observer_date_timeXconifer165 <- gmultmix(~ conifer_utm10_165, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXconifer165)

gTOD.models$observer_date_timeXconifer315 <- gmultmix(~ conifer_utm10_315, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = coef(gTOD.models$observer_date_timeXconifer165))
summary(gTOD.models$observer_date_timeXconifer315)

gTOD.models$observer_date_timeXconifer615 <- gmultmix(~ conifer_utm10_615, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXconifer615)

gTOD.models$observer_date_timeXconifer1215 <- gmultmix(~ conifer_utm10_1215, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXconifer1215)


## vlmr
gTOD.models$observer_date_timeXvlmr165 <- gmultmix(~ vlmr_utm10_165, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXvlmr165)

gTOD.models$observer_date_timeXvlmr315 <- gmultmix(~ vlmr_utm10_315, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXvlmr315)

gTOD.models$observer_date_timeXvlmr615 <- gmultmix(~ vlmr_utm10_615, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXvlmr615)

gTOD.models$observer_date_timeXvlmr1215 <- gmultmix(~ vlmr_utm10_1215, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXvlmr1215)
...
## ctf
gTOD.models$observer_date_timeXctf165 <- gmultmix(~ ctf_utm10_165, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXctf165)

gTOD.models$observer_date_timeXctf315 <- gmultmix(~ ctf_utm10_315, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXctf315)

gTOD.models$observer_date_timeXctf615 <- gmultmix(~ ctf_utm10_615, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXctf615)

gTOD.models$observer_date_timeXctf1215 <- gmultmix(~ ctf_utm10_1215, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXctf1215)


## devli
gTOD.models$observer_date_timeXdevli165 <- gmultmix(~ devli_utm10_165, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXdevli165)

gTOD.models$observer_date_timeXdevli315 <- gmultmix(~ devli_utm10_315, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, -0.00725, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXdevli315)

gTOD.models$observer_date_timeXdevli615 <- gmultmix(~ devli_utm10_615, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXdevli615)

gTOD.models$observer_date_timeXdevli1215 <- gmultmix(~ devli_utm10_1215, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXdevli1215)
...
## devos
gTOD.models$observer_date_timeXdevos165 <- gmultmix(~ devos_utm10_165, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXdevos165)

gTOD.models$observer_date_timeXdevos315 <- gmultmix(~ devos_utm10_315, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXdevos315)

gTOD.models$observer_date_timeXdevos615 <- gmultmix(~ devos_utm10_615, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXdevos615)

gTOD.models$observer_date_timeXdevos1215 <- gmultmix(~ devos_utm10_1215, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.93, 0.011, -10.534, 10.655, 11.373, 11.377, 0.123, -0.212, 21.3))
summary(gTOD.models$observer_date_timeXdevos1215)
...
current_suitable <- shapefile(file.path(output.directory, "cbch_suitable_poly_current_clipped.shp")) # This is the polygon of just suitable areas
...
historic_suitable <- shapefile(file.path(output.directory, "cbch_suitable_poly_historic_clipped.shp")) # This is the polygon of just suitable areas
...
writeRaster(subset(distsamp.density.current,subset=1), file.path(output.directory, "cbch_distsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=2), file.path(output.directory, "cbch_distsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=3), file.path(output.directory, "cbch_distsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=4), file.path(output.directory, "cbch_distsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 


distsamp.density.historic <- predict(dist.models$observer_timeXpred.occur2, type = "state", newdata = historic.stack)

writeRaster(subset(distsamp.density.historic,subset=1), file.path(output.directory, "cbch_distsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=2), file.path(output.directory, "cbch_distsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=3), file.path(output.directory, "cbch_distsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=4), file.path(output.directory, "cbch_distsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE) 
...
#writeRaster(subset(gdistsamp.density.current,subset=1), file.path(output.directory, "cbch_gdistsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=2), file.path(output.directory, "cbch_gdistsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=3), file.path(output.directory, "cbch_gdistsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=4), file.path(output.directory, "cbch_gdistsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 

#gdistsamp.density.historic <- predict(gdist.models$nullXpred.occur2, type = "lambda", newdata = historic.stack) 

#writeRaster(subset(gdistsamp.density.historic,subset=1), file.path(output.directory, "cbch_gdistsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=2), file.path(output.directory, "cbch_gdistsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=3), file.path(output.directory, "cbch_gdistsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=4), file.path(output.directory, "cbch_gdistsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
rem.abundance.current <- predict(Rem.models$observer_timeXpred.occur2, type = "state", newdata = current.stack) 
...
writeRaster(prediction, file.path(output.directory, "cbch_rem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "cbch_rem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "cbch_rem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "cbch_rem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

rem.abundance.historic <- predict(Rem.models$observer_timeXpred.occur2, type = "state", newdata = historic.stack) 
...
writeRaster(prediction, file.path(output.directory, "cbch_rem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "cbch_rem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "cbch_rem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "cbch_rem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "cbch_grem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "cbch_grem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "cbch_grem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "cbch_grem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "cbch_grem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "cbch_grem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "cbch_grem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "cbch_grem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
writeRaster(prediction, file.path(output.directory, "cbch_tod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "cbch_tod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "cbch_tod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "cbch_tod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
writeRaster(prediction, file.path(output.directory, "cbch_tod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "cbch_tod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "cbch_tod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "cbch_tod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "cbch_gtod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "cbch_gtod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "cbch_gtod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "cbch_gtod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "cbch_gtod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "cbch_gtod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "cbch_gtod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "cbch_gtod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
## distsamp
# Current
current.dens.prediction <- raster(file.path(output.directory, "cbch_distsamp_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "cbch_distsamp_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "cbch_distsamp_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "cbch_distsamp_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "cbch_distsamp_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "cbch_distsamp_historic_density180_upper.tif")) 
...
### gdistsamp
## Current
#current.dens.prediction <- raster(file.path(output.directory, "cbch_gdistsamp_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "cbch_gdistsamp_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "cbch_gdistsamp_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "cbch_gdistsamp_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "cbch_gdistsamp_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "cbch_gdistsamp_historic_density180_upper.tif")) 
...
## rem
# Current
current.dens.prediction <- raster(file.path(output.directory, "cbch_rem_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "cbch_rem_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "cbch_rem_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "cbch_rem_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "cbch_rem_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "cbch_rem_historic_density180_upper.tif")) 
...
### grem
## Current
#current.dens.prediction <- raster(file.path(output.directory, "cbch_grem_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "cbch_grem_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "cbch_grem_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "cbch_grem_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "cbch_grem_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "cbch_grem_historic_density180_upper.tif")) 
...
## tod
# Current
current.dens.prediction <- raster(file.path(output.directory, "cbch_tod_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "cbch_tod_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "cbch_tod_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "cbch_tod_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "cbch_tod_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "cbch_tod_historic_density180_upper.tif")) 
...
### gtod
## Current
#current.dens.prediction <- raster(file.path(output.directory, "cbch_gtod_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "cbch_gtod_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "cbch_gtod_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "cbch_gtod_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "cbch_gtod_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "cbch_gtod_historic_density180_upper.tif")) 
