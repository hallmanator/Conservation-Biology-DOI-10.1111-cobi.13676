...
occurrence.file <- "pawr_Chapter4.csv"
...
observations.covariates.file = "pawr_Chapter4.csv" 

TruncationD = 100 # This would be the truncation distance decided upon if there is one.
...
vlmr_cols <- grep("vlmr", names(model.data), value = FALSE) # Damn! For this species I should have included this!
...
covs <- observation.covariates.data[,c("Julian_Dat", "Year", "Observer", "Minutes_si", "urban_highmed_utm10_165", # First add detection covariates
                                       ...
                                       "conifer_utm10_165", "conifer_utm10_315", "conifer_utm10_615", "conifer_utm10_1215", 
                                       "vlmr_utm10_165", "vlmr_utm10_315", "vlmr_utm10_615", "vlmr_utm10_1215", 
...
## conifer
dist.models$observer_timeXconifer165 <- update(dist.models$observer_time, ~. ~conifer_utm10_165, starts = c(-0.469, 0.000963, -0.364, 4.935, 4.561, 4.538, -0.107)) # Update the best detection model with density covariates
summary(dist.models$observer_timeXconifer165)

dist.models$observer_timeXconifer315 <- update(dist.models$observer_time, ~. ~conifer_utm10_315, starts = c(-0.469, 0.000963, -0.364, 4.935, 4.561, 4.538, -0.107)) # Update the best detection model with density covariates
summary(dist.models$observer_timeXconifer315)

dist.models$observer_timeXconifer615 <- update(dist.models$observer_time, ~. ~conifer_utm10_615, starts = c(-0.469, 0.000963, -0.364, 4.935, 4.561, 4.538, -0.107)) # Update the best detection model with density covariates
summary(dist.models$observer_timeXconifer615)

dist.models$observer_timeXconifer1215 <- update(dist.models$observer_time, ~. ~conifer_utm10_1215, starts = c(-0.469, 0.000963, -0.364, 4.935, 4.561, 4.538, -0.107)) # Update the best detection model with density covariates
summary(dist.models$observer_timeXconifer1215)


## vlmr
dist.models$observer_timeXvlmr165 <- update(dist.models$observer_time, ~. ~vlmr_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_timeXvlmr165)

dist.models$observer_timeXvlmr315 <- update(dist.models$observer_time, ~. ~vlmr_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_timeXvlmr315)

dist.models$observer_timeXvlmr615 <- update(dist.models$observer_time, ~. ~vlmr_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_timeXvlmr615)

dist.models$observer_timeXvlmr1215 <- update(dist.models$observer_time, ~. ~vlmr_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_timeXvlmr1215)


## ctf
dist.models$observer_timeXctf165 <- update(dist.models$observer_time, ~. ~ctf_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_timeXctf165)

dist.models$observer_timeXctf315 <- update(dist.models$observer_time, ~. ~ctf_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_timeXctf315)

dist.models$observer_timeXctf615 <- update(dist.models$observer_time, ~. ~ctf_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_timeXctf615)

dist.models$observer_timeXctf1215 <- update(dist.models$observer_time, ~. ~ctf_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_timeXctf1215)


## riparian
dist.models$observer_timeXriparian165 <- update(dist.models$observer_time, ~. ~riparian2531_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_timeXriparian165)

dist.models$observer_timeXriparian315 <- update(dist.models$observer_time, ~. ~riparian2531_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_timeXriparian315)

dist.models$observer_timeXriparian615 <- update(dist.models$observer_time, ~. ~riparian2531_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_timeXriparian615)

dist.models$observer_timeXriparian1215 <- update(dist.models$observer_time, ~. ~riparian2531_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_timeXriparian1215)


## devos
dist.models$observer_timeXdevos165 <- update(dist.models$observer_time, ~. ~devos_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_timeXdevos165)

dist.models$observer_timeXdevos315 <- update(dist.models$observer_time, ~. ~devos_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_timeXdevos315)

dist.models$observer_timeXdevos615 <- update(dist.models$observer_time, ~. ~devos_utm10_615, starts = coef(dist.models$observer_timeXdevos315)) # Update the best detection model with density covariates
summary(dist.models$observer_timeXdevos615)

dist.models$observer_timeXdevos1215 <- update(dist.models$observer_time, ~. ~devos_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_timeXdevos1215)
...
dist.models$observer_timeXpred.occur2 <- update(dist.models$observer_time, ~. ~Pred.Occur + I(Pred.Occur^2)) # Update the best detection model with density covariates
...
summary(dist.models$observer_dateXpred.occur2) # Repeated but helps to remember to keep them all

dist.models$observer_timeXpred.occur2 <- update(dist.models$observer_time, ~. ~Pred.Occur + I(Pred.Occur^2)) # Update the best detection model with density covariates
summary(dist.models$observer_timeXpred.occur2)

dist.models$date_timeXpred.occur2 <- update(dist.models$date_time, ~. ~Pred.Occur + I(Pred.Occur^2)) # Update the best detection model with density covariates
summary(dist.models$date_timeXpred.occur2)

dist.models$observer_date_timeXpred.occur2 <- update(dist.models$observer_date_time, ~. ~Pred.Occur + I(Pred.Occur^2)) # Update the best detection model with density covariates
...
density.pred.pred.occur2 <- predict(dist.models$observer_timeXpred.occur2, type = "state", newdata = newdat, appendData=TRUE); density.pred.pred.occur2
...
# Goodness of fit
pb.dist <- parboot(dist.models$observer_timeXpred.occur2, fitstats, nsim=100, report=5); pb.dist
...
capture.output(summary(dist.models$observer_timeXpred.occur2), file = file.path(output.directory,filename))

# Detection probability for all bins within the 300m radius
p.bins <- getP(dist.models$observer_timeXpred.occur2)
...
p.distsamp <- mean(rowSums(getP(dist.models$observer_timeXpred.occur2))); p.distsamp

test <- predict(dist.models$observerXpred.occur2, type = "det", newdata = umf, appendData=FALSE)
...
## For pawr I'm starting with Riparian
...
# conifer
Rem.models$observer_date_timeXconifer165 <- multinomPois(~ Observer + JulDat + Time ~ conifer_utm10_165, umf.rem)
summary(Rem.models$observer_date_timeXconifer165)

Rem.models$observer_date_timeXconifer315 <- multinomPois(~ Observer + JulDat + Time ~ conifer_utm10_315, umf.rem)
summary(Rem.models$observer_date_timeXconifer315)

Rem.models$observer_date_timeXconifer615 <- multinomPois(~ Observer + JulDat + Time ~ conifer_utm10_615, umf.rem)
summary(Rem.models$observer_date_timeXconifer615)

Rem.models$observer_date_timeXconifer1215 <- multinomPois(~ Observer + JulDat + Time  ~ conifer_utm10_1215, umf.rem)
summary(Rem.models$observer_date_timeXconifer1215)
...
# Now try vlmr
Rem.models$observer_date_timeXvlmr165 <- multinomPois(~ Observer + JulDat + Time ~ vlmr_utm10_165, umf.rem)
summary(Rem.models$observer_date_timeXvlmr165)

Rem.models$observer_date_timeXvlmr315 <- multinomPois(~ Observer + JulDat + Time ~ vlmr_utm10_315, umf.rem)
summary(Rem.models$observer_date_timeXvlmr315)

Rem.models$observer_date_timeXvlmr615 <- multinomPois(~ Observer + JulDat + Time ~ vlmr_utm10_615, umf.rem)
summary(Rem.models$observer_date_timeXvlmr615)

Rem.models$observer_date_timeXvlmr1215 <- multinomPois(~ Observer + JulDat + Time  ~ vlmr_utm10_1215, umf.rem)
summary(Rem.models$observer_date_timeXvlmr1215)
...
# ctf
Rem.models$observer_date_timeXctf165 <- multinomPois(~ Observer + JulDat + Time ~ ctf_utm10_165, umf.rem)
summary(Rem.models$observer_date_timeXctf165)

Rem.models$observer_date_timeXctf315 <- multinomPois(~ Observer + JulDat + Time ~ ctf_utm10_315, umf.rem)
summary(Rem.models$observer_date_timeXctf315)

Rem.models$observer_date_timeXctf615 <- multinomPois(~ Observer + JulDat + Time ~ ctf_utm10_615, umf.rem)
summary(Rem.models$observer_date_timeXctf615)

Rem.models$observer_date_timeXctf1215 <- multinomPois(~ Observer + JulDat + Time  ~ ctf_utm10_1215, umf.rem)
summary(Rem.models$observer_date_timeXctf1215)


# riparian
Rem.models$observer_date_timeXriparian165 <- multinomPois(~ Observer + JulDat + Time ~ riparian2531_utm10_165, umf.rem)
summary(Rem.models$observer_date_timeXriparian165)

Rem.models$observer_date_timeXriparian315 <- multinomPois(~ Observer + JulDat + Time ~ riparian2531_utm10_315, umf.rem)
summary(Rem.models$observer_date_timeXriparian315)

Rem.models$observer_date_timeXriparian615 <- multinomPois(~ Observer + JulDat + Time ~ riparian2531_utm10_615, umf.rem)
summary(Rem.models$observer_date_timeXriparian615)

Rem.models$observer_date_timeXriparian1215 <- multinomPois(~ Observer + JulDat + Time  ~ riparian2531_utm10_1215, umf.rem)
summary(Rem.models$observer_date_timeXriparian1215)
...
# devos
Rem.models$observer_date_timeXdevos165 <- multinomPois(~ Observer + JulDat + Time ~ devos_utm10_165, umf.rem)
summary(Rem.models$observer_date_timeXdevos165)

Rem.models$observer_date_timeXdevos315 <- multinomPois(~ Observer + JulDat + Time ~ devos_utm10_315, umf.rem)
summary(Rem.models$observer_date_timeXdevos315)

Rem.models$observer_date_timeXdevos615 <- multinomPois(~ Observer + JulDat + Time ~ devos_utm10_615, umf.rem)
summary(Rem.models$observer_date_timeXdevos615)

Rem.models$observer_date_timeXdevos1215 <- multinomPois(~ Observer + JulDat + Time  ~ devos_utm10_1215, umf.rem)
summary(Rem.models$observer_date_timeXdevos1215)
...
abundance.pred.pred.occur2.rem <- predict(Rem.models$observer_date_timeXpred.occur2, type = "state", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.rem
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.rem <- parboot(Rem.models$observer_date_timeXpred.occur2, fitstats, nsim=100, report=5); pb.rem # Can't do this apparently because of the issues in the model
...
capture.output(summary(Rem.models$observer_date_timeXpred.occur2), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.rem <- mean(rowSums(getP(Rem.models$observer_date_timeXpred.occur2))); p.rem
...
gRem.models$observer_date_timeXriparian165 <- gmultmix(~ riparian2531_utm10_165, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXriparian165)

gRem.models$observer_date_timeXriparian315 <- gmultmix(~ riparian2531_utm10_315, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXriparian315)

gRem.models$observer_date_timeXriparian615 <- gmultmix(~ riparian2531_utm10_615, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXriparian615)

gRem.models$dobserver_date_timeXriparian1215 <- gmultmix(~ riparian2531_utm10_1215, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$dobserver_date_timeXriparian1215)

## Check if these are any good and what radius is best
MS.gRem.models <- modSel(fitList(fits=gRem.models));MS.gRem.models

## vlmr
gRem.models$observer_date_timeXvlmr165 <- gmultmix(~ vlmr_utm10_165, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXvlmr165)

gRem.models$observer_date_timeXvlmr315 <- gmultmix(~ vlmr_utm10_315, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXvlmr315)

gRem.models$observer_date_timeXvlmr615 <- gmultmix(~ vlmr_utm10_615, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXvlmr615)

gRem.models$dobserver_date_timeXvlmr1215 <- gmultmix(~ vlmr_utm10_1215, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$dobserver_date_timeXvlmr1215)


## conifer
gRem.models$observer_date_timeXconifer165 <- gmultmix(~ conifer_utm10_165, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXconifer165)

gRem.models$observer_date_timeXconifer315 <- gmultmix(~ conifer_utm10_315, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXconifer315)

gRem.models$observer_date_timeXconifer615 <- gmultmix(~ conifer_utm10_615, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXconifer615)

gRem.models$dobserver_date_timeXconifer1215 <- gmultmix(~ conifer_utm10_1215, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$dobserver_date_timeXconifer1215)


## ctf
gRem.models$observer_date_timeXctf165 <- gmultmix(~ ctf_utm10_165, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXctf165)

gRem.models$observer_date_timeXctf315 <- gmultmix(~ ctf_utm10_315, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXctf315)

gRem.models$observer_date_timeXctf615 <- gmultmix(~ ctf_utm10_615, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXctf615)

gRem.models$dobserver_date_timeXctf1215 <- gmultmix(~ ctf_utm10_1215, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$dobserver_date_timeXctf1215)


## devos
gRem.models$observer_date_timeXdevos165 <- gmultmix(~ devos_utm10_165, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXdevos165)

gRem.models$observer_date_timeXdevos315 <- gmultmix(~ devos_utm10_315, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXdevos315)

gRem.models$observer_date_timeXdevos615 <- gmultmix(~ devos_utm10_615, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXdevos615)

gRem.models$dobserver_date_timeXdevos1215 <- gmultmix(~ devos_utm10_1215, ~ 1, ~ Observer + JulDat + Time , umf.grem, mixture="NB", K=10)
summary(gRem.models$dobserver_date_timeXdevos1215)
...
## Now try habitat suitability as a predictor of abundance
gRem.models$observer_date_timeXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ Observer + JulDat + Time, umf.grem, mixture="NB", K=10)
summary(gRem.models$observer_date_timeXpred.occur)

gRem.models$observer_date_timeXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer + JulDat + Time, umf.grem, mixture="NB", K=10, starts = c(-0.347, 0, 0, -11.666, 13.521, 14.029, 13.453, -0.247, -0.246, 1.55))
...
gRem.models$observer_timeXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer + Time, umf.grem, mixture="NB", starts = c(-0.347, 0, 0, -11.666, 13.521, 14.029, 13.453, -0.246, 1.55))
...
gRem.models$observer_date_timeXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer + JulDat + Time, umf.grem, mixture="NB", starts = c(-0.347, 0, 0, -11.666, 13.521, 14.029, 13.453, -0.247, -0.246, 1.55))
summary(gRem.models$observer_date_timeXpred.occur2)
...
abundance.pred.pred.occur2.grem <- predict(gRem.models$observer_date_timeXpred.occur2, type = "lambda", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.grem
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.grem <- parboot(gRem.models$observer_date_timeXpred.occur2, fitstats, nsim=100, report=5); pb.grem 
...
capture.output(summary(gRem.models$observer_date_timeXpred.occur2), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.grem <- mean(rowSums(getP(gRem.models$observer_date_timeXpred.occur2))); p.grem
...
## conifer
TOD.models$observer_timeXconifer165 <- multinomPois(~ Observer + Time ~ conifer_utm10_165, umf.tod)
summary(TOD.models$observer_timeXconifer165)

TOD.models$observer_timeXconifer315 <- multinomPois(~ Observer + Time ~ conifer_utm10_315, umf.tod)
summary(TOD.models$observer_timeXconifer315)

TOD.models$observer_timeXconifer615 <- multinomPois(~ Observer + Time ~ conifer_utm10_615, umf.tod)
summary(TOD.models$observer_timeXconifer615)

TOD.models$observer_timeXconifer1215 <- multinomPois(~ Observer + Time ~ conifer_utm10_1215, umf.tod)
summary(TOD.models$observer_timeXconifer1215)
...
## vlmr
TOD.models$observer_timeXvlmr165 <- multinomPois(~ Observer + Time ~ vlmr_utm10_165, umf.tod)
summary(TOD.models$observer_timeXvlmr165)

TOD.models$observer_timeXvlmr315 <- multinomPois(~ Observer + Time ~ vlmr_utm10_315, umf.tod)
summary(TOD.models$observer_timeXvlmr315)

TOD.models$observer_timeXvlmr615 <- multinomPois(~ Observer + Time ~ vlmr_utm10_615, umf.tod)
summary(TOD.models$observer_timeXvlmr615)

TOD.models$observer_timeXvlmr1215 <- multinomPois(~ Observer + Time ~ vlmr_utm10_1215, umf.tod)
summary(TOD.models$observer_timeXvlmr1215)
...
abundance.pred.pred.occur2.tod <- predict(TOD.models$observer_timeXpred.occur2, type = "state", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.tod
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.tod <- parboot(TOD.models$observer_timeXpred.occur2, fitstats, nsim=100, report=5); pb.tod # Can't do this apparently because of the issues in the model
...
capture.output(summary(TOD.models$observer_timeXpred.occur2), file = file.path(output.directory,filename))


# Detection probability for a single pass
#backTransform(Rem.models$date_hwy2Xpred.occur2_wvups165, type="det")
head(getP(TOD.models$observer_timeXpred.occur2))

# Detection probability after all passes for each site. Could take an average across all sites
p.tod <- mean(rowSums(getP(TOD.models$observer_timeXpred.occur2))); p.tod
...
## conifer
gTOD.models$observer_timeXconifer165 <- gmultmix(~ conifer_utm10_165, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXconifer165)

gTOD.models$observer_timeXconifer315 <- gmultmix(~ conifer_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXconifer315)

gTOD.models$observer_timeXconifer615 <- gmultmix(~ conifer_utm10_615, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXconifer615)

gTOD.models$observer_timeXconifer1215 <- gmultmix(~ conifer_utm10_1215, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXconifer1215)
...
## vlmr
gTOD.models$observer_timeXvlmr165 <- gmultmix(~ vlmr_utm10_165, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXvlmr165)

gTOD.models$observer_timeXvlmr315 <- gmultmix(~ vlmr_utm10_315, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXvlmr315)

gTOD.models$observer_timeXvlmr615 <- gmultmix(~ vlmr_utm10_615, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXvlmr615)

gTOD.models$observer_timeXvlmr1215 <- gmultmix(~ vlmr_utm10_1215, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_timeXvlmr1215)
...
gTOD.models$observer_date_timeXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.368, 0, 0, -10.6896, 12.3157, 13.0805, 13.2778, -0.0021, -0.3981, 1.56))
...
abundance.pred.pred.occur2.gtod <- predict(gTOD.models$observer_timeXpred.occur2, type = "lambda", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.gtod
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.gtod <- parboot(gTOD.models$observer_timeXpred.occur2, fitstats, nsim=100, report=5); pb.gtod # Can't do this apparently because of the issues in the model
...
capture.output(summary(gTOD.models$observer_timeXpred.occur2), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.gtod <-mean(rowSums(getP(TOD.models$observer_timeXpred.occur2))); p.gtod
...
current_suitable <- shapefile(file.path(output.directory, "pawr_suitable_poly_current_clipped.shp")) # This is the polygon of just suitable areas
...
historic_suitable <- shapefile(file.path(output.directory, "pawr_suitable_poly_historic_clipped.shp")) # This is the polygon of just suitable areas
...
distsamp.density.current <- predict(dist.models$observer_timeXpred.occur2, type = "state", newdata = current.stack) 

writeRaster(subset(distsamp.density.current,subset=1), file.path(output.directory, "pawr_distsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=2), file.path(output.directory, "pawr_distsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=3), file.path(output.directory, "pawr_distsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=4), file.path(output.directory, "pawr_distsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 


distsamp.density.historic <- predict(dist.models$observer_timeXpred.occur2, type = "state", newdata = historic.stack)

writeRaster(subset(distsamp.density.historic,subset=1), file.path(output.directory, "pawr_distsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=2), file.path(output.directory, "pawr_distsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=3), file.path(output.directory, "pawr_distsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=4), file.path(output.directory, "pawr_distsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE) 
...
#writeRaster(subset(gdistsamp.density.current,subset=1), file.path(output.directory, "pawr_gdistsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=2), file.path(output.directory, "pawr_gdistsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=3), file.path(output.directory, "pawr_gdistsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=4), file.path(output.directory, "pawr_gdistsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 

#gdistsamp.density.historic <- predict(gdist.models$nullXpred.occur2, type = "lambda", newdata = historic.stack) 

#writeRaster(subset(gdistsamp.density.historic,subset=1), file.path(output.directory, "pawr_gdistsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=2), file.path(output.directory, "pawr_gdistsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=3), file.path(output.directory, "pawr_gdistsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=4), file.path(output.directory, "pawr_gdistsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "pawr_rem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "pawr_rem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "pawr_rem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "pawr_rem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "pawr_rem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "pawr_rem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "pawr_rem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "pawr_rem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)


## Density with negative binomial removal top model
grem.abundance.current <- predict(gRem.models$observer_date_timeXpred.occur2, type = "lambda", newdata = current.stack) 
...
writeRaster(prediction, file.path(output.directory, "pawr_grem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "pawr_grem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "pawr_grem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "pawr_grem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

grem.abundance.historic <- predict(gRem.models$observer_date_timeXpred.occur2, type = "lambda", newdata = historic.stack)
...
writeRaster(prediction, file.path(output.directory, "pawr_grem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "pawr_grem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "pawr_grem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "pawr_grem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)


### Density with time of detection top model
#tod.density.current <- predict(TOD.models$observer_dateXpred.occur2, type = "state", newdata = current.stack) 
...
#writeRaster(prediction, file.path(output.directory, "pawr_tod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "pawr_tod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "pawr_tod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "pawr_tod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

#tod.density.historic <- predict(TOD.models$observer_dateXpred.occur2, type = "state", newdata = historic.stack) 
...
#writeRaster(prediction, file.path(output.directory, "pawr_tod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "pawr_tod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "pawr_tod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "pawr_tod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)



## Density with negative binomial time of detection top model
gtod.density.current <- predict(gTOD.models$observer_timeXpred.occur2, type = "lambda", newdata = current.stack) 
...
writeRaster(prediction, file.path(output.directory, "pawr_gtod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "pawr_gtod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "pawr_gtod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "pawr_gtod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

gtod.density.historic <- predict(gTOD.models$observer_timeXpred.occur2, type = "lambda", newdata = historic.stack) 
...
writeRaster(prediction, file.path(output.directory, "pawr_gtod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "pawr_gtod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "pawr_gtod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "pawr_gtod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
## distsamp
# Current
current.dens.prediction <- raster(file.path(output.directory, "pawr_distsamp_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "pawr_distsamp_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "pawr_distsamp_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "pawr_distsamp_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "pawr_distsamp_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "pawr_distsamp_historic_density180_upper.tif")) 
...
### gdistsamp
## Current
#current.dens.prediction <- raster(file.path(output.directory, "pawr_gdistsamp_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "pawr_gdistsamp_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "pawr_gdistsamp_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "pawr_gdistsamp_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "pawr_gdistsamp_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "pawr_gdistsamp_historic_density180_upper.tif")) 
...
### rem
## Current
#current.dens.prediction <- raster(file.path(output.directory, "pawr_rem_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "pawr_rem_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "pawr_rem_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "pawr_rem_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "pawr_rem_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "pawr_rem_historic_density180_upper.tif")) 
...
## grem
# Current
current.dens.prediction <- raster(file.path(output.directory, "pawr_grem_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "pawr_grem_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "pawr_grem_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "pawr_grem_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "pawr_grem_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "pawr_grem_historic_density180_upper.tif")) 
...
### tod
## Current
#current.dens.prediction <- raster(file.path(output.directory, "pawr_tod_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "pawr_tod_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "pawr_tod_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "pawr_tod_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "pawr_tod_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "pawr_tod_historic_density180_upper.tif")) 
...
## gtod
# Current
current.dens.prediction <- raster(file.path(output.directory, "pawr_gtod_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "pawr_gtod_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "pawr_gtod_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "pawr_gtod_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "pawr_gtod_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "pawr_gtod_historic_density180_upper.tif")) 
