...
occurrence.file <- "weme_Chapter4.csv"
...
observations.covariates.file = "weme_Chapter4.csv" 

TruncationD = 250 # This would be the truncation distance decided upon if there is one.
...
###### Run the gbm ######
lr = 0.0075 # This is what I'm going to have to optimize as I go. Will take a couple tries.
...
covs <- observation.covariates.data[,c("Julian_Dat", "Year", "Observer", "Minutes_si", "urban_highmed_utm10_165", # First add detection covariates
                                       ...
                                       "npow16_utm10_165", "npow16_utm10_315", "npow16_utm10_615", "npow16_utm10_1215", # Now add density covariates
                                       "marsh3334_utm10_165", "marsh3334_utm10_315", "marsh3334_utm10_615", "marsh3334_utm10_1215", 
                                       "wvups22_utm10_165", "wvups22_utm10_315", "wvups22_utm10_615","wvups22_utm10_1215", 
                                       "wvwp23_utm10_165", "wvwp23_utm10_315", "wvwp23_utm10_615", "wvwp23_utm10_1215", 
                                       "Pred.Occur")]
...
## marsh
dist.models$observer_dateXmarsh165 <- update(dist.models$observer_date, ~. ~marsh3334_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_dateXmarsh165)

dist.models$observer_dateXmarsh315 <- update(dist.models$observer_date, ~. ~marsh3334_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_dateXmarsh315)

dist.models$observer_dateXmarsh615 <- update(dist.models$observer_date, ~. ~marsh3334_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_dateXmarsh615)

dist.models$observer_dateXmarsh1215 <- update(dist.models$observer_date, ~. ~marsh3334_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_dateXmarsh1215)


## npow
dist.models$observer_dateXnpow165 <- update(dist.models$observer_date, ~. ~npow16_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_dateXnpow165)

dist.models$observer_dateXnpow315 <- update(dist.models$observer_date, ~. ~npow16_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_dateXnpow315)

dist.models$observer_dateXnpow615 <- update(dist.models$observer_date, ~. ~npow16_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_dateXnpow615)

dist.models$observer_dateXnpow1215 <- update(dist.models$observer_date, ~. ~npow16_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_dateXnpow1215)


## wvups
dist.models$observer_dateXwvups165 <- update(dist.models$observer_date, ~. ~wvups22_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_dateXwvups165)

dist.models$observer_dateXwvups315 <- update(dist.models$observer_date, ~. ~wvups22_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_dateXwvups315)

dist.models$observer_dateXwvups615 <- update(dist.models$observer_date, ~. ~wvups22_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_dateXwvups615)

dist.models$observer_dateXwvups1215 <- update(dist.models$observer_date, ~. ~wvups22_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_dateXwvups1215)


## wvwp
dist.models$observer_dateXwvwp165 <- update(dist.models$observer_date, ~. ~wvwp23_utm10_165) # Update the best detection model with density covariates
summary(dist.models$observer_dateXwvwp165)

dist.models$observer_dateXwvwp315 <- update(dist.models$observer_date, ~. ~wvwp23_utm10_315) # Update the best detection model with density covariates
summary(dist.models$observer_dateXwvwp315)

dist.models$observer_dateXwvwp615 <- update(dist.models$observer_date, ~. ~wvwp23_utm10_615) # Update the best detection model with density covariates
summary(dist.models$observer_dateXwvwp615)

dist.models$observer_dateXwvwp1215 <- update(dist.models$observer_date, ~. ~wvwp23_utm10_1215) # Update the best detection model with density covariates
summary(dist.models$observer_dateXwvwp1215)
...
summary(dist.models$observer_dateXpred.occur)

dist.models$observer_dateXpred.occur2 <- update(dist.models$observer_date, ~. ~Pred.Occur + I(Pred.Occur^2)) # Update the best detection model with density covariates
...
density.pred.pred.occur2 <- predict(dist.models$observer_dateXpred.occur2, type = "state", newdata = newdat, appendData=TRUE); density.pred.pred.occur2
...
# Goodness of fit
pb.dist <- parboot(dist.models$observer_dateXpred.occur2, fitstats, nsim=100, report=5); pb.dist
...
capture.output(summary(dist.models$observer_dateXpred.occur2), file = file.path(output.directory,filename))

# Detection probability for all bins within the 300m radius
p.bins <- getP(dist.models$observer_dateXpred.occur2)
...
p.distsamp <- mean(rowSums(getP(dist.models$observer_dateXpred.occur2))); p.distsamp

test <- predict(dist.models$observer_dateXpred.occur2, type = "det", newdata = umf.dist, appendData=FALSE)
...
## For weme I'm starting with Riparian
...
## marsh
Rem.models$dateXmarsh165 <- multinomPois(~ JulDat ~ marsh3334_utm10_165, umf.rem)
summary(Rem.models$dateXmarsh165)

Rem.models$dateXmarsh315 <- multinomPois(~ JulDat ~ marsh3334_utm10_315, umf.rem)
summary(Rem.models$dateXmarsh315)

Rem.models$dateXmarsh615 <- multinomPois(~ JulDat ~ marsh3334_utm10_615, umf.rem)
summary(Rem.models$dateXmarsh615)

Rem.models$dateXmarsh1215 <- multinomPois(~ JulDat  ~ marsh3334_utm10_1215, umf.rem)
summary(Rem.models$dateXmarsh1215)
...
# npow
Rem.models$dateXnpow165 <- multinomPois(~ JulDat ~ npow16_utm10_165, umf.rem)
summary(Rem.models$dateXnpow165)

Rem.models$dateXnpow315 <- multinomPois(~ JulDat ~ npow16_utm10_315, umf.rem)
summary(Rem.models$dateXnpow315)

Rem.models$dateXnpow615 <- multinomPois(~ JulDat ~ npow16_utm10_615, umf.rem)
summary(Rem.models$dateXnpow615)

Rem.models$dateXnpow1215 <- multinomPois(~ JulDat  ~ npow16_utm10_1215, umf.rem)
summary(Rem.models$dateXnpow1215)


# wvups
Rem.models$dateXwvups165 <- multinomPois(~ JulDat ~ wvups22_utm10_165, umf.rem)
summary(Rem.models$dateXwvups165)

Rem.models$dateXwvups315 <- multinomPois(~ JulDat ~ wvups22_utm10_315, umf.rem)
summary(Rem.models$dateXwvups315)

Rem.models$dateXwvups615 <- multinomPois(~ JulDat ~ wvups22_utm10_615, umf.rem)
summary(Rem.models$dateXwvups615)

Rem.models$dateXwvups1215 <- multinomPois(~ JulDat  ~ wvups22_utm10_1215, umf.rem)
summary(Rem.models$dateXwvups1215)


# Now try wvwp
Rem.models$dateXwvwp165 <- multinomPois(~ JulDat ~ wvwp23_utm10_165, umf.rem)
summary(Rem.models$dateXwvwp165)

Rem.models$dateXwvwp315 <- multinomPois(~ JulDat ~ wvwp23_utm10_315, umf.rem)
summary(Rem.models$dateXwvwp315)

Rem.models$dateXwvwp615 <- multinomPois(~ JulDat ~ wvwp23_utm10_615, umf.rem)
summary(Rem.models$dateXwvwp615)

Rem.models$dateXwvwp1215 <- multinomPois(~ JulDat  ~ wvwp23_utm10_1215, umf.rem)
summary(Rem.models$dateXwvwp1215)
...
Rem.models$observerXpred.occur2 <- multinomPois(~ Observer ~ Pred.Occur + I(Pred.Occur^2), umf.rem, starts = c(-2.46, 6.55, -3.36, -5.55, 6.77, 5.72, 6.12))
...
Rem.models$observer_timeXpred.occur2 <- multinomPois(~ Observer + Time ~ Pred.Occur  + I(Pred.Occur^2), umf.rem, starts = c(-2.46, 6.55, -3.36, -8.5617, 9.9027, 8.8227, 9.2728, -0.0594))
...
abundance.pred.pred.occur2.rem <- predict(Rem.models$dateXpred.occur2, type = "state", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.rem
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.rem <- parboot(Rem.models$dateXpred.occur2, fitstats, nsim=100, report=5); pb.rem # Can't do this apparently because of the issues in the model
...
capture.output(summary(Rem.models$dateXpred.occur2), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.rem <- mean(rowSums(getP(Rem.models$dateXpred.occur2))); p.rem
...
## marsh
gRem.models$dateXmarsh165 <- gmultmix(~ marsh3334_utm10_165, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXmarsh165)

gRem.models$dateXmarsh315 <- gmultmix(~ marsh3334_utm10_315, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXmarsh315)

gRem.models$dateXmarsh615 <- gmultmix(~ marsh3334_utm10_615, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXmarsh615)

gRem.models$dateXmarsh1215 <- gmultmix(~ marsh3334_utm10_1215, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXmarsh1215)
...
## NPOW
gRem.models$dateXnpow165 <- gmultmix(~ npow16_utm10_165, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXnpow165)

gRem.models$dateXnpow315 <- gmultmix(~ npow16_utm10_315, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXnpow315)

gRem.models$dateXnpow615 <- gmultmix(~ npow16_utm10_615, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXnpow615)

gRem.models$dateXnpow1215 <- gmultmix(~ npow16_utm10_1215, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXnpow1215)


## WVUPS
gRem.models$dateXwvups165 <- gmultmix(~ wvups22_utm10_165, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXwvups165)

gRem.models$dateXwvups315 <- gmultmix(~ wvups22_utm10_315, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXwvups315)

gRem.models$dateXwvups615 <- gmultmix(~ wvups22_utm10_615, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXwvups615)

gRem.models$dateXwvups1215 <- gmultmix(~ wvups22_utm10_1215, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXwvups1215)


## wvwp
gRem.models$dateXwvwp165 <- gmultmix(~ wvwp23_utm10_165, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXwvwp165)

gRem.models$dateXwvwp315 <- gmultmix(~ wvwp23_utm10_315, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXwvwp315)

gRem.models$dateXwvwp615 <- gmultmix(~ wvwp23_utm10_615, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXwvwp615)

gRem.models$dateXwvwp1215 <- gmultmix(~ wvwp23_utm10_1215, ~ 1, ~ JulDat , umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXwvwp1215)
...
## Now try habitat suitability as a predictor of abundance
gRem.models$dateXpred.occur <- gmultmix(~ Pred.Occur, ~ 1, ~ JulDat, umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXpred.occur)

gRem.models$dateXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ JulDat, umf.grem, mixture="NB", K=10)
summary(gRem.models$dateXpred.occur2)
...
gRem.models$observerXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer, umf.grem, mixture="NB", starts = c(-2.48, 6.67, -3.47, -9.36, 10.59, 9.51, 9.97, 0.045))
summary(gRem.models$observerXpred.occur2)

gRem.models$dateXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ JulDat, umf.grem, mixture="NB", K=10, starts = c(-2.48, 6.67, -3.47, 1.372, -0.456, 0.055))
summary(gRem.models$dateXpred.occur2)

gRem.models$timeXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Time, umf.grem, mixture="NB", K=10, starts = c(-2.48, 6.67, -3.47, 0.3287, 0.0216, 0.0474))
summary(gRem.models$timeXpred.occur2)

gRem.models$observer_dateXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer + JulDat, umf.grem, mixture="NB", starts = c(-2.48, 6.67, -3.47, -9.36, 10.59, 9.51, 9.97, 0, 0.045))
summary(gRem.models$observer_dateXpred.occur2)

gRem.models$observer_timeXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer + Time, umf.grem, mixture="NB", starts = c(-2.48, 6.67, -3.47, -9.36, 10.59, 9.51, 9.97, 0, 0.045))
...
abundance.pred.pred.occur2.grem <- predict(gRem.models$dateXpred.occur2, type = "lambda", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.grem
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.grem <- parboot(gRem.models$dateXpred.occur2, fitstats, nsim=100, report=5); pb.grem 
...
capture.output(summary(gRem.models$dateXpred.occur2), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.grem <- mean(rowSums(getP(gRem.models$dateXpred.occur2))); p.grem
...
TOD.models$observer <- multinomPois(~ Observer ~ 1, umf.tod, starts = c(-0.145, -7.008, 9.337, 9.039, 9.387))
...
## marsh
TOD.models$observer_date_timeXmarsh165 <- multinomPois(~ Observer + JulDat + Time ~ marsh3334_utm10_165, umf.tod)
summary(TOD.models$observer_date_timeXmarsh165)

TOD.models$observer_date_timeXmarsh315 <- multinomPois(~ Observer + JulDat + Time ~ marsh3334_utm10_315, umf.tod)
summary(TOD.models$observer_date_timeXmarsh315)

TOD.models$observer_date_timeXmarsh615 <- multinomPois(~ Observer + JulDat + Time ~ marsh3334_utm10_615, umf.tod)
summary(TOD.models$observer_date_timeXmarsh615)

TOD.models$observer_date_timeXmarsh1215 <- multinomPois(~ Observer + JulDat + Time ~ marsh3334_utm10_1215, umf.tod)
summary(TOD.models$observer_date_timeXmarsh1215)
...
## npow
TOD.models$observer_date_timeXnpow165 <- multinomPois(~ Observer + JulDat + Time ~ npow16_utm10_165, umf.tod)
summary(TOD.models$observer_date_timeXnpow165)

TOD.models$observer_date_timeXnpow315 <- multinomPois(~ Observer + JulDat + Time ~ npow16_utm10_315, umf.tod)
summary(TOD.models$observer_date_timeXnpow315)

TOD.models$observer_date_timeXnpow615 <- multinomPois(~ Observer + JulDat + Time ~ npow16_utm10_615, umf.tod)
summary(TOD.models$observer_date_timeXnpow615)

TOD.models$observer_date_timeXnpow1215 <- multinomPois(~ Observer + JulDat + Time ~ npow16_utm10_1215, umf.tod)
summary(TOD.models$observer_date_timeXnpow1215)
...
## wvups
TOD.models$observer_date_timeXwvups165 <- multinomPois(~ Observer + JulDat + Time ~ wvups22_utm10_165, umf.tod)
summary(TOD.models$observer_date_timeXwvups165)

TOD.models$observer_date_timeXwvups315 <- multinomPois(~ Observer + JulDat + Time ~ wvups22_utm10_315, umf.tod)
summary(TOD.models$observer_date_timeXwvups315)

TOD.models$observer_date_timeXwvups615 <- multinomPois(~ Observer + JulDat + Time ~ wvups22_utm10_615, umf.tod)
summary(TOD.models$observer_date_timeXwvups615)

TOD.models$observer_date_timeXwvups1215 <- multinomPois(~ Observer + JulDat + Time ~ wvups22_utm10_1215, umf.tod)
summary(TOD.models$observer_date_timeXwvups1215)
...
## wvwp
TOD.models$observer_date_timeXwvwp165 <- multinomPois(~ Observer + JulDat + Time ~ wvwp23_utm10_165, umf.tod)
summary(TOD.models$observer_date_timeXwvwp165)

TOD.models$observer_date_timeXwvwp315 <- multinomPois(~ Observer + JulDat + Time ~ wvwp23_utm10_315, umf.tod)
summary(TOD.models$observer_date_timeXwvwp315)

TOD.models$observer_date_timeXwvwp615 <- multinomPois(~ Observer + JulDat + Time ~ wvwp23_utm10_615, umf.tod)
summary(TOD.models$observer_date_timeXwvwp615)

TOD.models$observer_date_timeXwvwp1215 <- multinomPois(~ Observer + JulDat + Time ~ wvwp23_utm10_1215, umf.tod)
summary(TOD.models$observer_date_timeXwvwp1215)
...
TOD.models$observerXpred.occur2 <- multinomPois(~ Observer ~ Pred.Occur + I(Pred.Occur^2), umf.tod, starts = c(-2.47, 6.55, -3.36, -7.85, 9.15, 8.49, 9.29))
...
TOD.models$observer_dateXpred.occur2 <- multinomPois(~ Observer + JulDat ~ Pred.Occur + I(Pred.Occur^2), umf.tod, starts = c(-2.47, 6.55, -3.36, -7.85, 9.15, 8.49, 9.29, 0))
summary(TOD.models$observer_dateXpred.occur2)

TOD.models$observer_timeXpred.occur2 <- multinomPois(~ Observer + Time ~ Pred.Occur + I(Pred.Occur^2), umf.tod, starts = c(-2.47, 6.55, -3.36, -7.85, 9.15, 8.49, 9.29, 0))
...
abundance.pred.pred.occur2.tod <- predict(TOD.models$observer_date_timeXpred.occur2, type = "state", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.tod
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.tod <- parboot(TOD.models$observer_date_timeXpred.occur2, fitstats, nsim=100, report=5); pb.tod # Can't do this apparently because of the issues in the model
...
capture.output(summary(TOD.models$observer_date_timeXpred.occur2), file = file.path(output.directory,filename))


# Detection probability for a single pass
#backTransform(Rem.models$date_hwy2Xpred.occur2_wvups165, type="det")
head(getP(TOD.models$observer_date_timeXpred.occur2))

# Detection probability after all passes for each site. Could take an average across all sites
p.tod <- mean(rowSums(getP(TOD.models$observer_date_timeXpred.occur2))); p.tod
...
gTOD.models$observer <- gmultmix(~ 1, ~ 1, ~ Observer, umf.gtod, mixture="NB", K=10, starts = c(-0.145, -4.852, 7.168, 6.861, 7.217, 0.0477))
...
gTOD.models$observer_time <- gmultmix(~ 1, ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10, starts = c(-0.145, -4.852, 7.168, 6.861, 7.217, 0, 0.0477))
...
## marsh
gTOD.models$observer_date_timeXmarsh165 <- gmultmix(~ marsh3334_utm10_165, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXmarsh165)

gTOD.models$observer_date_timeXmarsh315 <- gmultmix(~ marsh3334_utm10_315, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXmarsh315)

gTOD.models$observer_date_timeXmarsh615 <- gmultmix(~ marsh3334_utm10_615, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXmarsh615)

gTOD.models$observer_date_timeXmarsh1215 <- gmultmix(~ marsh3334_utm10_1215, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXmarsh1215)


## npow
gTOD.models$observer_date_timeXnpow165 <- gmultmix(~ npow16_utm10_165, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXnpow165)

gTOD.models$observer_date_timeXnpow315 <- gmultmix(~ npow16_utm10_315, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXnpow315)

gTOD.models$observer_date_timeXnpow615 <- gmultmix(~ npow16_utm10_615, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXnpow615)

gTOD.models$observer_date_timeXnpow1215 <- gmultmix(~ npow16_utm10_1215, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXnpow1215)


## wvups
gTOD.models$observer_date_timeXwvups165 <- gmultmix(~ wvups22_utm10_165, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXwvups165)

gTOD.models$observer_date_timeXwvups315 <- gmultmix(~ wvups22_utm10_315, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXwvups315)

gTOD.models$observer_date_timeXwvups615 <- gmultmix(~ wvups22_utm10_615, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXwvups615)

gTOD.models$observer_date_timeXwvups1215 <- gmultmix(~ wvups22_utm10_1215, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXwvups1215)
...
## wvwp
gTOD.models$observer_date_timeXwvwp165 <- gmultmix(~ wvwp23_utm10_165, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXwvwp165)

gTOD.models$observer_date_timeXwvwp315 <- gmultmix(~ wvwp23_utm10_315, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXwvwp315)

gTOD.models$observer_date_timeXwvwp615 <- gmultmix(~ wvwp23_utm10_615, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXwvwp615)

gTOD.models$observer_date_timeXwvwp1215 <- gmultmix(~ wvwp23_utm10_1215, ~ 1, ~ Observer + JulDat + Time, umf.gtod, mixture="NB", K=10)
summary(gTOD.models$observer_date_timeXwvwp1215)
...
gTOD.models$observerXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer, umf.gtod, mixture="NB", K=10, starts = c(-2.49, 6.67, -3.47, -8.74, 10.04, 9.38, 10.19, 0.0538))
...
gTOD.models$observer_timeXpred.occur2 <- gmultmix(~ Pred.Occur + I(Pred.Occur^2), ~ 1, ~ Observer + Time, umf.gtod, mixture="NB", K=10, starts = c(-2.49, 6.67, -3.47, -8.74, 10.04, 9.38, 10.19, 0, 0.0538))
...
abundance.pred.pred.occur2.gtod <- predict(gTOD.models$observer_date_timeXpred.occur2, type = "lambda", newdata = newdat, appendData=TRUE); abundance.pred.pred.occur2.gtod
...
## Check the goodness of fit of the best model and export summary
# Goodness of fit
pb.gtod <- parboot(gTOD.models$observer_date_timeXpred.occur2, fitstats, nsim=100, report=5); pb.gtod # Can't do this apparently because of the issues in the model
...
capture.output(summary(gTOD.models$observer_date_timeXpred.occur2), file = file.path(output.directory,filename))


# Detection probability after all passes for each site. Could take an average across all sites
p.gtod <-mean(rowSums(getP(TOD.models$observer_date_timeXpred.occur2))); p.gtod
...
current_suitable <- shapefile(file.path(output.directory, "weme_suitable_poly_current_clipped.shp")) # This is the polygon of just suitable areas
...
historic_suitable <- shapefile(file.path(output.directory, "weme_suitable_poly_historic_clipped.shp")) # This is the polygon of just suitable areas
...
distsamp.density.current <- predict(dist.models$observer_dateXpred.occur2, type = "state", newdata = current.stack) 

writeRaster(subset(distsamp.density.current,subset=1), file.path(output.directory, "weme_distsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=2), file.path(output.directory, "weme_distsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=3), file.path(output.directory, "weme_distsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.current,subset=4), file.path(output.directory, "weme_distsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 


distsamp.density.historic <- predict(dist.models$observer_dateXpred.occur2, type = "state", newdata = historic.stack)

writeRaster(subset(distsamp.density.historic,subset=1), file.path(output.directory, "weme_distsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=2), file.path(output.directory, "weme_distsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=3), file.path(output.directory, "weme_distsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(subset(distsamp.density.historic,subset=4), file.path(output.directory, "weme_distsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE) 
...
#writeRaster(subset(gdistsamp.density.current,subset=1), file.path(output.directory, "weme_gdistsamp_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=2), file.path(output.directory, "weme_gdistsamp_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=3), file.path(output.directory, "weme_gdistsamp_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.current,subset=4), file.path(output.directory, "weme_gdistsamp_current_density180_upper.tif"), format="GTiff", overwrite=TRUE) 

#gdistsamp.density.historic <- predict(gdist.models$nullXpred.occur2, type = "lambda", newdata = historic.stack) 

#writeRaster(subset(gdistsamp.density.historic,subset=1), file.path(output.directory, "weme_gdistsamp_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=2), file.path(output.directory, "weme_gdistsamp_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=3), file.path(output.directory, "weme_gdistsamp_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(subset(gdistsamp.density.historic,subset=4), file.path(output.directory, "weme_gdistsamp_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#rem.abundance.current <- predict(Rem.models$observer_dateXpred.occur2, type = "state", newdata = current.stack) 
...
#writeRaster(prediction, file.path(output.directory, "weme_rem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "weme_rem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "weme_rem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "weme_rem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

#rem.abundance.historic <- predict(Rem.models$observer_dateXpred.occur2, type = "state", newdata = historic.stack) 
...
#writeRaster(prediction, file.path(output.directory, "weme_rem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "weme_rem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "weme_rem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "weme_rem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)


## Density with negative binomial removal top model
grem.abundance.current <- predict(gRem.models$dateXpred.occur2, type = "lambda", newdata = current.stack) 
...
writeRaster(prediction, file.path(output.directory, "weme_grem_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "weme_grem_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "weme_grem_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "weme_grem_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

grem.abundance.historic <- predict(gRem.models$dateXpred.occur2, type = "lambda", newdata = historic.stack)
...
writeRaster(prediction, file.path(output.directory, "weme_grem_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "weme_grem_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "weme_grem_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "weme_grem_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)


## Density with time of detection top model
tod.density.current <- predict(TOD.models$observer_date_timeXpred.occur2, type = "state", newdata = current.stack) 
...
writeRaster(prediction, file.path(output.directory, "weme_tod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "weme_tod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "weme_tod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "weme_tod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)

tod.density.historic <- predict(TOD.models$observer_date_timeXpred.occur2, type = "state", newdata = historic.stack) 
...
writeRaster(prediction, file.path(output.directory, "weme_tod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(se, file.path(output.directory, "weme_tod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(lower, file.path(output.directory, "weme_tod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
writeRaster(upper, file.path(output.directory, "weme_tod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "weme_gtod_current_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "weme_gtod_current_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "weme_gtod_current_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "weme_gtod_current_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
#writeRaster(prediction, file.path(output.directory, "weme_gtod_historic_density180.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(se, file.path(output.directory, "weme_gtod_historic_density180_se.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(lower, file.path(output.directory, "weme_gtod_historic_density180_lower.tif"), format="GTiff", overwrite=TRUE) 
#writeRaster(upper, file.path(output.directory, "weme_gtod_historic_density180_upper.tif"), format="GTiff", overwrite=TRUE)
...
## distsamp
# Current
current.dens.prediction <- raster(file.path(output.directory, "weme_distsamp_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "weme_distsamp_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "weme_distsamp_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "weme_distsamp_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "weme_distsamp_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "weme_distsamp_historic_density180_upper.tif")) 
...
### gdistsamp
## Current
#current.dens.prediction <- raster(file.path(output.directory, "weme_gdistsamp_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "weme_gdistsamp_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "weme_gdistsamp_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "weme_gdistsamp_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "weme_gdistsamp_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "weme_gdistsamp_historic_density180_upper.tif")) 
...
### rem
## Current
#current.dens.prediction <- raster(file.path(output.directory, "weme_rem_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "weme_rem_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "weme_rem_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "weme_rem_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "weme_rem_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "weme_rem_historic_density180_upper.tif")) 
...
## grem
# Current
current.dens.prediction <- raster(file.path(output.directory, "weme_grem_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "weme_grem_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "weme_grem_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "weme_grem_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "weme_grem_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "weme_grem_historic_density180_upper.tif")) 
...
## tod
# Current
current.dens.prediction <- raster(file.path(output.directory, "weme_tod_current_density180.tif")) 
...
current.dens.lower <- raster(file.path(output.directory, "weme_tod_current_density180_lower.tif")) 
...
current.dens.upper <- raster(file.path(output.directory, "weme_tod_current_density180_upper.tif")) 
...
# Historic
historic.dens.prediction <- raster(file.path(output.directory, "weme_tod_historic_density180.tif")) 
...
historic.dens.lower <- raster(file.path(output.directory, "weme_tod_historic_density180_lower.tif")) 
...
historic.dens.upper <- raster(file.path(output.directory, "weme_tod_historic_density180_upper.tif")) 
...
### gtod
## Current
#current.dens.prediction <- raster(file.path(output.directory, "weme_gtod_current_density180.tif")) 
...
#current.dens.lower <- raster(file.path(output.directory, "weme_gtod_current_density180_lower.tif")) 
...
#current.dens.upper <- raster(file.path(output.directory, "weme_gtod_current_density180_upper.tif")) 
...
## Historic
#historic.dens.prediction <- raster(file.path(output.directory, "weme_gtod_historic_density180.tif")) 
...
#historic.dens.lower <- raster(file.path(output.directory, "weme_gtod_historic_density180_lower.tif")) 
...
#historic.dens.upper <- raster(file.path(output.directory, "weme_gtod_historic_density180_upper.tif")) 
